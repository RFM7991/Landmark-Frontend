...
var methods = {
   ...
   getPopulation : function(lat, lng, callback) {
    ...
    census({
      ...
      (err, res) => {
        callback(filter.filterPopulation(res))
      }
    )
  },

  getAge: function(lat, lng, range, callback) {
    console.log('GET AGE')

    var params = [ vars.POPULATION.AGE.MEDIAN.TOTAL,
      vars.POPULATION.GENDER.MALE.TOTAL,
 ...
 getIncome : function(lat, lng, range, callback) {
