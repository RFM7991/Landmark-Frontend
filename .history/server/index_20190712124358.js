...
app.get('/api/demo/age/:range/:lat/:lng', (req, res) => {
  city.getAge(req.params.lat, req.params.lng, req.params.range, (data) => {
    res.setHeader('Content-Type', 'application/json');
    res.send(data);
  })
})
...
app.get('/api/demo/income/:range/:lat/:lng', (req, res) => {
  city.getIncome(req.params.lat, req.params.lng, req.params.range, (data) => {
    res.setHeader('Content-Type', 'application/json');
    res.send(data);
  })
})
...
app.get('/api/demo/social/:range/:lat/:lng', (req, res) => {
  city.getSocial(req.params.lat, req.params.lng, req.params.range, (data) => {
    res.setHeader('Content-Type', 'application/json');
    res.send(data);
  })
})
