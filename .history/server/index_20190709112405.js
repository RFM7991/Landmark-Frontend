...
////////////////// Cartography ////////////////////
app.get('/api/cartography/:lat/:lng', (req, res) => {
  console.log(root)
  cartography.getCart(req.params.lat, req.params.lng, (data) => {
    res.setHeader('Content-Type', 'application/json')
    res.send(data)
  })
 /* fetch('https://storage.googleapis.com/mapsdevsite/json/google.json')
    .then(r => r.json())
