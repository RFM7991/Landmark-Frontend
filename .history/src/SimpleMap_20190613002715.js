...
class SimpleMap extends Component {
  ...
  constructor(props) {
    ...
    // listen to store
    store.subscribe(() => {
      this.setState(store.getState(), ()=> console.log('update map', this.state.active_place))
      if (this.state.active_place != undefined)
        this.props.center= this.state.active_place.geometry.location
