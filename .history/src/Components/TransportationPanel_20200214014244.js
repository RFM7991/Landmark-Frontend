...
class TransportationPanel extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{flexDirection: 'column', padding: '1.5em', width: '100%', backgroundColor: lightBg}}>
                ...
                {this.props.transportation.subways.size > 0 &&
                    <img src={nySubwayMap} width='20%'></img>
                }
            </div>    
       )
    }
