  ...
  updateRadii() {
   ...
   /*   
      ...
      */
      ...
      let points1 = getPoints(this.state.center, 3.2, 30)
      let points2 = getPoints(this.state.center, 2.4, 25)
      let points3 = getPoints(this.state.center, 1.6, 20)
      let points4 = getPoints(this.state.center, 0.8, 15)
      let points5 = getPoints(this.state.center, 0.267, 6)
      ...
      let outerRing = getPoints(this.state.center, 8.046, 50)
      outerRing.forEach((e,i) => {
        renderMarker(i, e, this.state.map, e.lat + ', ' + e.lng, RED_MARKER)
      })
