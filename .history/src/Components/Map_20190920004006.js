...
class SimpleMap extends Component {
  ...
  //  if (this.state.isCity != undefined) {
      ...
      if (this.props.isCity) {
        ...
        let circle1Distance = 402
        let circle2Distance = 804
         const circle1 = renderCircle(circle1Distance, "#00ff00", this.state.map, this.state.center) //0.0125 miles, 402m
         const circle2 = renderCircle(circle1Distance, "#ffff00", this.state.map, this.state.center) // 0.25 miles, 804m
      ...
      let circle1Distance = 4828
      let circle2Distance = 8046
       const circle1 = renderCircle(circle1Distance, "#00ff00", this.state.map, this.state.center) // 3 miles 4828
       const circle2 = renderCircle(circle2Distance, "#ffff00", this.state.map, this.state.center) // 5 miles 8046
       // to-do cleanup, add label
