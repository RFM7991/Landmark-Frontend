  ...
  updateRadii() {
   ...
   /*   
      ...
      */
      ...
      let points2 = getPoints(this.state.center, 3.8, 10)
      let points3 = getPoints(this.state.center, 3.0, 50)
      let points4 = getPoints(this.state.center, 3.0, 10)
      let points5 = getPoints(this.state.center, 2., 40)
      let points6 = getPoints(this.state.center, 2.2, 10)
      let points7 = getPoints(this.state.center, 2.0, 30)
      let points8 = getPoints(this.state.center, 1.5, 10)
      let points9 = getPoints(this.state.center, 0.7, 10)
