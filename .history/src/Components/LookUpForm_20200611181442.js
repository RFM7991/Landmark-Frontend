        ...
        return (
            <div className="lookup-form-block">
                ...
                <div style={{ display: 'flex', flexDirection: 'row', backgroundColor: 'red'}}>
                        ...
                        <div style={{ flex: 1}}/>
                        <div style={{ flex: 2, alignItems: 'flex-end', justifyContent: 'center'}}>
                            <Form.Label color="black" style={{color: textPrimary, fontSize: '22px'}}>Address</Form.Label> 
                        </div>
               
                        <div style={{flex: 1, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: 'green' }}>
                            <div style={{ fontSize: '14px', marginRight: '0.5em', color: 'white'}}>How to use</div>
            ...
            <div style={{ marginTop: '2em', backgroundColor: 'rgba(1,1,1,0.6'}}>
                      <p style={{ fontSize: 18, color: 'whitesmoke', padding: 5, margin: 'auto'}}>*Current locations support New Jersey, the 5 boroughs of New York City, and Long Island, New York USA</p>
            </div>
        </div>
        );
    }
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <p>
                <span><strong>*Current locations support New Jersey, the 5 boroughs of New York City, and Long Island, New York USA</strong> </span>   
              <br></br>
