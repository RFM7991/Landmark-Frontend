    ...
    if (this.props.ready) {
      ...
      var map = <div>
        <div className="results-container">
          ...
          <div style={{height: '75vh', '50%'}}>
            <SimpleMap height={'100%'} address={this.props.address} center={this.props.address.coords} zoom={15} business_type={this.props.business_type}/>
          </div>
          <PlacesList/>
          </div>
          <br></br>
