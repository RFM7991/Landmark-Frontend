...
class SimpleMap extends Component {
  ...
  updateRadii() {
      if (this.props.isCity) {
        ...
        let points1 = getPoints(this.state.center, 0.285, 20)
        let points2 = getPoints(this.state.center, 0.15, 10)
        let points3 = getPoints(this.state.center, 0.08, 5)
        let testPoints = points1.concat(points2).concat(points3)
