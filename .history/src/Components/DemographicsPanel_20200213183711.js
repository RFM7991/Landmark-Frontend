      ...
      >
        ...
        <h3 style={{fontSize: '20px'}}>
          ...
          <p style={{ marginLeft: '1em'}}>
              ...
              <br></br>
              <span >Zip codes may contain visible gaps, especially in urban areas. 
              ...
              <br></br>
              <span>The 'Trade Zone' is calculated by aggregating the set of census <a href='https://www2.census.gov/geo/pdfs/education/CensusTracts.pdf'>tracts </a> 
                that fall within a radius of 1 mile for 'driving' and 0.25 miles for 'walking.'</span>
                <br></br>
                <span>Note that results may vary if location is bordering areas not within the following locations: </span>
                <br></br>
                <span>New Jersey, the 5 boroughs of New York City, and Long Island</span>
              </p>
          </p>
          <h3 style={{fontSize: '20px'}}>
            2. Statistics
