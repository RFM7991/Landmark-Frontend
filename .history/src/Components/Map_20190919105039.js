  ...
  updateRadii() {
    ...
    if (this.state.isCity != undefined) {
      ...
      if (this.state.isCity) {
        //  0.220 : 0.402);
         const circle1 = renderCircle(402, "#00ff00", this.state.map, this.state.center) //0.0125 miles, 402m
         const circle2 = renderCircle(804, "#ffff00", this.state.map, this.state.center) // 0.25 miles, 804m
