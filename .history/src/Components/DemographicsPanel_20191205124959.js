    ...
    render() {
        ...
        const NestedCard = ({name, data, key_i}) => {
            return (
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey={key_i} style={{color: 'whitesmoke', backgroundColor: darkBg}}>
                        {name}
                        </Accordion.Toggle>
        ...
        return (
           <div className={this.props.orientation} style={{backgroundColor: lightBg, display: 'flex', flexDirection: 'column'}}>
            ...
            <div>
                <div style={{ textAlign: 'center', backgroundColor: darkBg }}>
                <br></br>
            ...
            <div style={{ flexGrow: 1, overflowY: 'auto', backgroundColor: lightBg}}>
               <Accordion defaultActiveKey="0" >
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey="0" style={{color: 'whitesmoke', backgroundColor: darkBg}}>
                    General
                    </Accordion.Toggle>
                ...
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey="1" style={{color: 'whitesmoke', backgroundColor: darkBg}}>
                    Social
                    </Accordion.Toggle>
                ...
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey="0" style={{color: 'whitesmoke', background: darkBg}}>
                    Age
                    </Accordion.Toggle>
                    <Accordion.Collapse eventKey="0" >
                    <Card.Body>
