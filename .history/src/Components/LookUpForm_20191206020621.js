      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">
            Enter an address of a potential real estate site
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <h3 style={{fontSize: '20px'}}>
            1. Start typng a street address or the name of a business and select from the autofill results.
          </h3>
          <p>
              <span> Note: For intersections type the first street then '&amp;' then the next street.</span>   
              <br></br>
            <span>
          ...
          <p>
              <span> Note: For 'Residential' business types, nearby establishments will be displayed instead of competitors</span>   
