...
import { renderCircle, renderMarker, renderComplexMarker, renderInfoContent, BLUE_MARKER, YELLOW_MARKER, GREEN_MARKER, RED_MARKER, YELLOW_DOT, BLUE_DOT } from './GoogleMapComponents'
...
class SimpleMap extends Component {
  ...
  updateRadii() {
      if (this.props.isCity) {
        ...
        renderComplexMarker('circle1', points[0], this.state.map, '0.25 mi', YELLOW_DOT, new google.maps.Point(16, 9))
        ...
        const circle2 = renderCircle(circle2Distance, "#0000ff", this.state.map, this.state.center) 
        // to-do cleanup, add label
          let points = getPoints(this.state.center, 4.8225)
          console.log(points[0])
          renderComplexMarker('circle1', points[0], this.state.map, '3 mi', YELLOW_DOT, new google.maps.Point(16, 9))
          points = getPoints(this.state.center, 8.046)
          renderMarker('circle1', points[0], this.state.map, '5 mi', BLUE_MARKER)
      }
  }
