  ...
  <div>
      {this.state.hasListing && 
        <div style={{ display: 'flex', flexDirection: 'row',  alignItems: 'center', justifyContent: 'center', width: '100%', height: '2em', backgroundColor: 'whitesmoke'}}>
            <div><span>This location has a listing, click </span> <div style={{ color : "blue"}} onClick={this.generateHeading.navigateToListing}>here</div> <span> for details</span></div>
          </div>
      }
