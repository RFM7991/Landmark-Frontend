...
/*
    ...
    render() {
        ...
        return (
            <div style={{ position: 'absolute', left: '25%', height: '100%', width: '100%', display: 'flex', justifyContent:'center', alignItems: 'center', zIndex: 1000}}>
         
                <div style={{  display: 'flex', flexDirection: 'row', width: '50%', height: '80%', marginRight: '1.5em'}}>
