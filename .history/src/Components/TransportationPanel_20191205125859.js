...
class TransportationPanel extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{display: 'block',  flexDirection: 'column', paddingLeft: '2em', width: '50%', backgroundColor: lightBg}}>
                <h1 style={{color: 'whitesmoke', }}>Transportation</h1>
                <ReactTableContainer width='100%' height={this.state.tableHeight} customHeader={[header]}>
