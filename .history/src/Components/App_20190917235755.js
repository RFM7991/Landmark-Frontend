...
class App extends React.Component { 
  ...
  render() {
    ...
    console.log('sign', sign('/maps/api/streetview?size=200x600&location=46.414382,10.013988&heading=151.78&pitch=-0.76&key=AIzaSyDc1QhQx9sfS2E-ZdM0cDQuVtM_NlQhdSU') )
