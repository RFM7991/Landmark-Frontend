  ...
  render() {
    ...
    return (
      <div>
        <Switch>
          <Route
          path={'/Landmark-Frontend/:address/:business_type/:distance'}
          render={(({match}) => {
        ...
        <Route
          exact path={'/Landmark-Frontend/login'}
          render={(({match}) => {
            return <div>
                <NavigationBar/>
                <div className="App">
        ...
        <Route
           exact path={'/Landmark-Frontend/register'}
          render={(({match}) => {
            return <div>
                <NavigationBar/>
                <div className="App">
