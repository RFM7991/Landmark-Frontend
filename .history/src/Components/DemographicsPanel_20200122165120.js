                        ...
                        <tbody>
                            {
                                ...
                                let entry = capitalize(data[0].replace(/_/g, ' '))
                    ...
                    <Card.Body>
                        ...
                        <tbody>
                            ...
                            <td>Sample total</td><td>{formatCommas(income_data.sample_total)}</td>
                             ...
                             <td>150-200k</td><td>{getPercent(income_data._150000_199999, income_data.total_households)}</td>
                             </tr><tr>
                             <td>200k+</td><td>{getPercent(income_data._200000_MORE, income_data.total_households)}</td>
                             </tr>
                        </tbody>
                        </Table>
                    </Card.Body>
