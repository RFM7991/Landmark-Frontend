        ...
        return (
            <Navbar style={{background: navBg}} expand="lg">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                 ...
                 {props.user._id != -1 && <Link to="/addlisting" style={{color: "whitesmoke", fontWeight: 'bold',  stroke: 'black', strokeWidth: 2, fontFamily: 'Tahoma, Geneva, sans-serif'}}>Add a Listing</Link>}
