               ...
               <Accordion defaultActiveKey='0'>
                ...
                <Card style={{backgroundColor: lightBg}}>
                    ...
                    <Card.Body>
                        ...
                        {this.props.data_range == ZIP && !this.props.isCity && <NestedCard name={"Nativity"} data={social_data.nativity} key_i={"1"}></NestedCard> }
                        {this.props.data_range == ZIP && !this.props.isCity &&<NestedCard name={"Education (Ages 25+)"} data={social_data.education} key_i={"2"}></NestedCard> }
                        <NestedCard name={"Marital Status (Ages 15+)"} data={social_data.marital_status} key_i={"3"}></NestedCard> 
                        {this.props.data_range == ZIP && !this.props.isCity &&<NestedCard name={"Transportation (for work)"} data={social_data.transportation} key_i={"4"}></NestedCard> }
                        </Accordion>
                    </Card.Body>
                    </Accordion.Collapse>
                </Card>
