        ...
        return (
            <div className="lookup-form-block">
                ...
                <div style={{ display: 'flex', flexDirection: 'row'}}>
                    <Form.Label color="black" style={{color: textPrimary}}>Address</Form.Label> <Form.Label style={{color: textPrimary}} style={{color: textPrimary}}>Your Proposed Business Type</Form.Label>
