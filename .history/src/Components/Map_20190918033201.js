...
class SimpleMap extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (this.props.places !== prevProps.places) {
      if (this.state.map != undefined) {
        console.log('places update', this.props.places)
  ...
  updateRadii() {
   ...
   // markers
  updateMarkers = (map) =>  {
    console.log('UPDATING MARKERS start', this.props.places.length, this.state.markers.size)
    ...
    console.log(count, marker, markerMap.size)
  })
  this.setState({ markers : markerMap})
  this.updateInfoWindow(map)
  console.log('UPDATING MARKERS end', this.props.places.length, this.state.markers.size)
}
