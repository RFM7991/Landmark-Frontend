...
/*
    ...
    render() {
        ...
        return (
            <div style={{  width: '100%', display: 'flex', justifyContent:'center', alignItems: 'center', zIndex: 1000, }}>
         
                <div style={{ position: 'absolute',  display: 'flex', flexDirection: 'row', width: '80%', marginRight: '1.5em'}}>
                    <AutoCompleteBar urlParams={this.props.urlParams} addressFunction={this.getAddress} fontSize="18px"/>
                </div>

            <Form style={{   position: 'relative', flexDirection : 'row', justifyContent: 'center', }}>
