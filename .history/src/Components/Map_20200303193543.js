  ...
  updateRadii() {
   ...
   /*   
      ...
      */
      ...
      let points2 = getPoints(this.state.center, 4, 50)
      let points3 = getPoints(this.state.center, 4.5, 10)
      let points4 = getPoints(this.state.center, 3, 40)
      let points5 = getPoints(this.state.center, 2.5, 10)
      let points6 = getPoints(this.state.center, 2.0, 30)
      let points7 = getPoints(this.state.center, 1.5, 10)
      let points8 = getPoints(this.state.center, 1, 15)
      let points = points1.concat(points2).concat(points3).concat(points4).concat(points5).concat(points6).concat(points7).concat(points8)
      console.log(points)
      points.forEach((e, i) => {
        renderMarker(i, e, this.state.map, e.lat + ', ' + e.lng, GREEN_MARKER)
      })
