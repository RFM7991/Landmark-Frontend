      ...
      var content ='<h3>Your ' + this.props.business_type.toString() +'</h3>'
       ...
       if (this.state.isCity != undefined) {
         if (this.state.isCity) {
           //  0.220 : 0.402);
            const circle1 = renderCircle(220, "#00ff00", map, center)
            const circle2 = renderCircle(402, "#ffff00", map, center)
         } else if (!this.state.isCity) {
          const circle1 = renderCircle(402, "#00ff00", map, center)
          const circle2 = renderCircle(804, "#ffff00", map, center)
         }
       }
