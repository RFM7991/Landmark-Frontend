    ...
    return (
      ...
      >
        ...
        <h3 style={{fontSize: '20px'}}>
            1. Select Zip Code or Tradezone
          </h3>
          <p>
              <p>
              <strong> Zip Codes </strong>   
              <br></br>
              <span style={{ fontSize: 14}}>Zip codes may contain visible gaps, especially in urban areas. This will occurr in the special case of a designated zip code for a particular building or complex such as Penn Station or the Empire State Building </span>
              </p>
              <p>
              <strong> Trade Zone </strong>   
              <br></br>
              <span style={{ fontSize: 14}}>The 'Trade Zone' is calculated by aggregating the set of census <a href='https://www2.census.gov/geo/pdfs/education/CensusTracts.pdf'>tracts</a> </span>
              </p>
          </p>
