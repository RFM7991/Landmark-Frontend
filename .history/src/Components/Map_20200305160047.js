  ...
  updateRadii() {
   ...
   /*   
      ...
      */
      ...
      let counter = 1;
      let divisor = 15
      let increment = 4.628 / divisor
      for (let i=0; i <= divisor; i++) {
        console.log('POINT', i, counter*5 )
        points = points.concat(getPoints(this.state.center, i*increment, counter*5 ))
        counter+=1
      }
      /*
      .concat(this.state.center, 1.0, 10)
      .concat(getPoints(this.state.center, 1.5, 10))
      .concat(getPoints(this.state.center, 2.2, 30))
      .concat(getPoints(this.state.center, 2.6, 10))
      .concat(getPoints(this.state.center, 3.0, 40))
      .concat(getPoints(this.state.center, 3.4, 10))
      .concat(getPoints(this.state.center, 3.8, 50))
      .concat(getPoints(this.state.center, 4.2, 10))
      .concat(getPoints(this.state.center, 4.628, 50))
      */
      console.log(points)
