  ...
  updateRadii() {
   ...
   /*   
      ...
      */
      ...
      let points2 = getPoints(this.state.center, 4.3, 10)
      let points3 = getPoints(this.state.center, 4, 50)
      let points4 = getPoints(this.state.center, 3.7, 10)
      let points5 = getPoints(this.state.center, 3, 40)
      let points6 = getPoints(this.state.center, 2.7, 10)
