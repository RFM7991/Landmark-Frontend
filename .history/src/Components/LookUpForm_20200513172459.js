    ...
    render() {
        ...
        return (
            <div className="lookup-form-block">
                <div style={{ display: 'flex', backgroundColor: 'green', minHeight: '64px', justifyContent: 'center', alignItems: 'center' }}>
                    {this.state.error && <p style={{ color: 'red', fontSize: 16}}>{this.state.errorMessage}</p>}
                </div>
                <div>
            ...
            <Form style={{ flexDirection : 'row', justifyContent: 'center'}}>
                {this.state.address != undefined && <Button  variant="primary" onClick={this.onHandleSubmit} style={{backgroundColor:'#00d4ff', fontWeight: 'bold'}}>
                    Submit</Button>
                }
