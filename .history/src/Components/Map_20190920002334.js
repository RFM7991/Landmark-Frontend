...
class SimpleMap extends Component {
  ...
  constructor(props) {
    ...
    setInterval( () => {
      ...
      console.log('check', this.props.tradeZone_bounds, this.state.cartographyLoaded)
      if (this.props.tradeZone_bounds != undefined && !this.state.cartographyLoaded) {
        console.log('Fetching cartography')
        getTradeZoneCartography(this.props.address.state.toLowerCase(), this.props.tradeZone_bounds)
        .then((data) => {
