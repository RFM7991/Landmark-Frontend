...
class DemographicsPanel extends React.Component {
   ...
   async componentDidUpdate(prevProps) {
    ...
    render() {
        ...
        const NestedCard = ({name, data, key_i}) => {
            return (
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey={key_i} style={{color: 'whitesmoke'}}>
                        {name}
                        </Accordion.Toggle>
        ...
        return (
           <div className={this.props.orientation} style={{backgroundColor: darkBg}}>
            <div style={{width: '100hv'}}>
               
            </div>
                <br></br>
                <div style={{ textAlign: 'center', backgroundColor: lightBg, height:'100%'}}>
               ...
               <Accordion defaultActiveKey="0" >
                ...
                <Card style={{backgroundColor: darkBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey="1" style={{color: 'whitesmoke'}}>
                    Social
                    </Accordion.Toggle>
