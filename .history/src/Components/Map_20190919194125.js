...
import { activeSelector, addressSelector, businessTypeSelector, dataRangeSelector, placesSelector, stateSelector, tractSelector, zipSelector, isCitySelector } from '../Reducers/selectors'
...
class SimpleMap extends Component {
  ...
  loadCartography() {
    ...
    getTradeZoneCartography(this.props.address.state.toString().toLowerCase(), this.props.center.lat, this.props.center.lng, this.props.isCity)
      .then((data) => {
        let mCartography = Object.assign({}, this.state.cartography)
  ...
  //  if (this.state.isCity != undefined) {
      ...
      if (this.props.isCity) {
        console.log('is a city', this.state.ap)
        //  0.220 : 0.402);
         ...
         const circle4 = renderCircle(880, "#ff0000", this.state.map, this.state.center) // 0.25 miles, 804m
...
const mapStateToProps = createSelector(
  ...
  dataRangeSelector,
  isCitySelector,
  (places, active_place, address, business_type, zip, state, tract, data_range, isCity) => ({
    places, 
    active_place,
    address,
    business_type,
