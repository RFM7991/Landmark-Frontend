    ...
    render() {
        ...
        return (
            <div style={{ height: '100%', width: '100%', display: 'flex', justifyContent:'center', alignItems: 'center'}}>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', width: '100%', height: '80%', marginRight: '1.5em'}}>
                    <AutoCompleteBar urlParams={this.props.urlParams} addressFunction={this.getAddress} fontSize="16px"/>
                </div>

            <Form style={{ flexDirection : 'row', justifyContent: 'center', }}>
                {this.state.address != undefined && <Button  disabled={this.state.error} variant="primary" onClick={this.onHandleSubmit} style={{backgroundColor:'#00d4ff', fontWeight: 'bold', fontSize: '14px'}}>
                    Go</Button>
                }
                {this.state.address == undefined && <Button  variant="primary" onClick={this.onHandleAddressWarning} style={{backgroundColor:'#00d4ff', fontWeight: 'bold', opacity: 0.75, fontSize: '14px'}}>
                    Go</Button>
                }
            </Form>
        </div>
