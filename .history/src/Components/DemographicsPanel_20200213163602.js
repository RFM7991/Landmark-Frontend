        ...
        return (
           <div className={this.props.orientation} style={{backgroundColor: lightBg, display: 'flex', flexDirection: 'column'}}>
             ...
             <div style={{ display: 'flex', flexDirection: 'column', width: '100%'}}>
                    <div style={{ display: 'flex',flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'blue' }}>
                        <p></p>
                        <strong style={{color:'whitesmoke', backgroundColor: 'green'}}>Demographics</strong>
                        <InfoButton style={{marginRight: '1em'}} clickFunction={()=>this.setModalShow(true)}/>   
...
const LoadingButton = (props) => {
  ...
  const InfoButton = (props) => {
    ...
    let style = {color: color, backgroundColor: 'red'}
