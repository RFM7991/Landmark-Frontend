  ...
  updateRadii() {
      if (this.props.isCity) {
        ...
        let circle2Distance = 1608 // 0.5 mi
         const circle1 = renderCircle(circle1Distance, "#ff0000", this.state.map, this.state.center) 
         const circle2 = renderCircle(circle2Distance, "#00ff00", this.state.map, this.state.center) 
          // to-do cleanup, add label
        let points = getPoints(this.state.center, 0.804 )
        renderMarker('circle1', points[0], this.state.map, '0.5 miles', YELLOW_DOT)
        points = getPoints(this.state.center, 1.604)
        renderMarker('circle1', points[0], this.state.map, '0.5 miles', BLUE_DOT)
        ...
        // to-do cleanup, add label
          ...
          renderMarker('circle1', points[0], this.state.map, '3 miles', YELLOW_DOT)
          points = getPoints(this.state.center, 8046)
          renderMarker('circle1', points[0], this.state.map, '5 miles', BLUE_DOT)
      }
  }
