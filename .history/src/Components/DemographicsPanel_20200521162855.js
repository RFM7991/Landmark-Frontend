...
class DemographicsPanel extends React.Component {
   ...
   //     if (this.props.address.isNewEntry) {
    ...
    onBusinessFormChange = (event) => {
        this.onUpdateBusinessType({ type : event.target.value })
    }
                        ...
                        <tbody style={{overflowX: 'auto'}}>
                            ...
                            <td><Form.Row>
                                <Form.Group as={Col} controlId="formGridZip">
                                    ...
                                    <Form.Control as="select" name="business_type" value={this.props.business_type.type} onChange={this.onBusinessFormChange}>
