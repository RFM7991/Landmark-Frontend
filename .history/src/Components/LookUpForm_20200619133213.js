        ...
        return (
            <div className="lookup-form-block">
                ...
                <div style={{ width: '100%',  display: 'flex'}}>
                    <div style={{ flex: 1, display: 'flex', backgroundColor: 'red', alignItems: 'flex-end', justifyContent: 'flex-end' }}>
                        <h3 color="black" style={{color: textPrimary, fontSize: '22px', backgroundColor: 'green', textAlign: 'left', marginLeft: '1em'}}>Address</h3> 
                    </div>
