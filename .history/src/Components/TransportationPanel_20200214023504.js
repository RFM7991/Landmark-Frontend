            ...
            <div style={{flexDirection: 'column', alignItems: 'flex-start', padding: '1.5em', width: '100%', backgroundColor: lightBg}}>
                ...
                <div style={{ backgroundColor: 'green'}}>
                    ...
                    enlargedImagePosition='beside'
                     />
                       <a  style={{ backgroundColor: 'red', marginRight: 'auto', marginLeft: 'auto', width: 100}} href="https://upload.wikimedia.org/wikipedia/commons/3/3a/Official_New_York_City_Subway_Map_vc.jpg" target="_blank" >See full size</a>
                     </div>
                }
