...
class SimpleMap extends Component {
  ...
  onUpdateTradeZoneBounds(tradeZone_bounds) {
    let cart = getBlockGroups(tradeZone_bounds)
    console.log('NEW BOUNDS', cart )
    this.setState({ new_cart : cart})
  ...
  renderCartography() {
    ...
    console.log('GEO_JSON', blockdata)
    if (this.state.new_cart == undefined) {
      this.state.map.data.addGeoJson(blockdata)
    } else {
      this.state.new_cart.forEach(e => {
