            ...
            <div style={{ width: '100%', height: '100%', backgroundColor: 'rgba(255,255,255, 0.9)', display: 'flex'}}>
                 ...
                 <div style={{ width: '100%', height: '100vh', display: 'flex', flexDirection: 'column'}}>
                     <div style={{ width: '100%', height: '7.5%', backgroundColor: 'red', display: 'flex'}}>
                        ...
                        <Button style={{ borderRadius: 0, flex: 1, borderLeft: '1px solid white'}} variant={(this.state.index == 1) ? "primary" : "secondary"} onClick={() => this.setState({ index : 1})}>My Listings</Button>
                     </div>
