    ...
    render() {
        let header =  <thead>
            <tr style={{ fontSize: 16}}>
                <th></th><th>Address</th><th>Business Type</th>
            </tr>
        </thead>
        return (
            ...
            {this.props.loading &&  <div style={{ width: '100%', height: '80vh', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: darkBg}}> <GridLoader color={"#0892d0"}/> </div>}
            {!this.state.loading && 
              ...
              {!this.props.loading && this.props.listings.length == 0 &&  <div style={{ width: '100%', height: '80vh', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: darkBg, color : 'white'}}><p>Sorry, there are no listings yet for these parameters</p></div>}
            </div>    
       )
    }
 }
