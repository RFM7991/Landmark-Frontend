...
class RecentSearches extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{display: 'block',  flexDirection: 'column', marginTop: '1.5em', padding: '1.5em', width: '100%', height: '100%'}}>
 ...
 const SearchesRows = (props) => {
    ...
    const getURL = (value) => {
        let address = encodeURI(value.location.formatted)
        let business_type = encodeURI(value.business_type.type)
