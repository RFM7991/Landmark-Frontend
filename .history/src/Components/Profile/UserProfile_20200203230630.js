...
class ProfilePanel extends React.Component {
    ...
    render() {
        return (
            ...
            display: 'columns', alignItems: 'center', alignContent: 'center', justifyContent: 'center', backgroundColor: 'blue'}}>
                ...
                <div style={{ marginTop: '1em', color: 'black', textAlign: 'left', width: '50%', backgroundColor: 'red'}}>
