    ...
    return (
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter"style={{ display : 'flex', justifyContent: 'center',backgroundColor: 'green'}}>
           <p style={{ textAlign : center}}>Are you sure you want to remove this listing?</p>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body style={{ display : 'flex', justifyContent: 'center'}}>
         <Button onClick={props.handleAction} variant="danger" style={{ marginRight: '2em'}}>
            Delete
         </Button>
