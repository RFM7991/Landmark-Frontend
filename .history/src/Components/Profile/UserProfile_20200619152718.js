    ...
    handleSubmit = async (event) => {
        ...
        if (form.checkValidity() === true) {
                ...
                if (isValid) {
                    ...
                    alert('You have successfully edited your user profile')
                }
            }
        ...
        return (
            ...
            display: 'columns', alignItems: 'center',  justifyContent: 'center' }}>
                <div style={{ marginTop: '2em', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
                  <img src={(this.state.photos.length > 0) ? URL.createObjectURL(this.state.photos[0]) : 'https://media-exp1.licdn.com/dms/image/C4E03AQGIviyGnEnlyQ/profile-displayphoto-shrink_200_200/0?e=1586390400&v=beta&t=RIDnoFwrm22DeH-yGzlaZvLewKS6MDXIza6YrWK5GOQ'} 
