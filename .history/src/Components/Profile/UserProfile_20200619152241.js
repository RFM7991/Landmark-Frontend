...
class ProfilePanel extends React.Component {
    ...
    handleUploadProfile = async () => {
        ...
        formData.append("profile", this.state.profilePics[0])
    ...
    render() {
        return (
            ...
            display: 'columns', alignItems: 'center',  justifyContent: 'center' }}>
                <div style={{ marginTop: '2em', backgroundColor: 'red', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
