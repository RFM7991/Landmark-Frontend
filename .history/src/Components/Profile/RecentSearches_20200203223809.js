...
class RecentSearches extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{display: 'block',  flexDirection: 'column', marginTop: '1.5em', padding: '1.5em', width: '50%', backgroundColor: lightBg}}>
                <h1 style={{color: 'whitesmoke', }}>Recent Searches</h1>
                <ReactTableContainer height={this.state.tableHeight} width='50%' customHeader={[header]}>
