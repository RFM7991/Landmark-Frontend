            ...
            <div style={{ width: '100%', height: '100%', backgroundColor: 'rgba(255,255,255, 0.9)', display: 'flex'}}>
                 ...
                 <div style={{ width: '100%', height: '100vh', display: 'flex', flexDirection: 'column'}}>
                     <div style={{ width: '100%', height: '7.5%', backgroundColor: 'red', display: 'flex'}}>
                        <Button style={{ borderRadius: 0, flex: 1, fontSize: '18px', borderRight: '0.25px solid white', fontWeight: (this.state.index == 0) ? 'bold' : 'regular'}} 
                        variant={(this.state.index == 0) ? "primary" : "secondary"} onClick={() => this.setState({ index : 0})}>Recent Searches</Button>

                        <Button style={{ borderRadius: 0, flex: 1, borderLeft: '0.25px solid white'}}
