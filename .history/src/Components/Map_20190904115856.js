...
import { renderCircle, renderMarker, popUpInfoContent } from './GoogleMapComponents'
...
class SimpleMap extends Component {
  ...
  constructor(props) {
    ...
    this.get = this.getInfoContent.bind(this)
  }
  ...
  value.marker.addListener('click',  () => {
       this.onUpdateActivePlace(value.place)
        ...
        var infowindow = new google.maps.InfoWindow({
          content: ReactDOMServer.renderToStaticMarkup(getInfoContent(value.place).bind(this))
        });
