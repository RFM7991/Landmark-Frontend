...
import { getAge, getIncome, getSocial, getTradeZoneStats, getZipStats  } from '../Requests/city-requests' 
...
class DemographicsPanel extends React.Component {
   ...
   onUpdateDataRange(event) {
    ...
    async getData() {
       ...
       await getTradeZoneStats(this.props.lat, this.props.lng, this.props.isCity).then(data => this.setState({tradeZoneStats : data}))
    }
    render() {
