...
class SimpleMap extends Component {
  ...
  updateRadii() {
      if (this.props.isCity) {
        ...
        let points1 = getPoints(this.state.center, 0.4, 15)
        let points2 = getPoints(this.state.center, 0.3, 12)
        let points3 = getPoints(this.state.center, 0.2, 9)
        let points4 = getPoints(this.state.center, 0.1, 6)
