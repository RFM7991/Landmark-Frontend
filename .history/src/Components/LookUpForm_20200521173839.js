        ...
        return (
            <div className="lookup-form-block">
                ...
                <div style={{ display: 'flex', flexDirection: 'row'}}>
                    <div style={{ width: '30%', alignItems: 'flex-end', justifyContent: 'center'}}>
                        <Form.Label style={{color: textPrimary}} style={{color: textPrimary, fontSize: '16px'}}>Your Proposed Business Type</Form.Label>
                    </div>
