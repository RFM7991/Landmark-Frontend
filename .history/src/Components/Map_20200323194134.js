...
class SimpleMap extends Component {
  ...
  async updateRadii() {
    ...
    if (county[0].state == '34' || (county[0].state == '36' && (county[0].county == '103' || county[0].county == '059'))) {
          ...
          renderComplexMarker('circle2', points[0], this.state.map, '5 mi', BLUE_DOT_05, new google.maps.Point(60, 60))
      ...
      if (this.props.isCity) {
        ...
        renderComplexMarker('circle1', points[0], this.state.map, '0.5 mi', YELLOW_DOT_3, new google.maps.Point(60, 60))
