...
class NavigationBar extends React.Component {
    ...
    render() {
        ...
        if (this.props.user._id == -1) {
             button = <Button  onClick={(e) => this.props.history('/login')} style={{backgroundColor:'#00d4ff', fontWeight: 'bold'}}>Login</Button>
        } else {
             button = 
             <Button  onClick={(e) => {
        ...
        return (
            <Navbar style={{background: navBg}} expand="lg">
                <Navbar.Brand href="/Landmark-Frontend/home" style={{color: "whitesmoke", fontWeight: 'bold',  stroke: 'black', strokeWidth: 2, fontFamily: 'Tahoma, Geneva, sans-serif'}}>Landmark</Navbar.Brand>
