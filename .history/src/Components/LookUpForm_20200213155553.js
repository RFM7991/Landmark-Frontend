...
class LookUpForm extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div style={{ paddingTop: '2em', backgroundColor: 'rgba(1,1,1,0.6'}}>
                      <p style={{ fontSize: 18, padding: 5, margin: 'auto'}}>*Current locations support New Jersey, the 5 boroughs of New York City, and Long Island</p>
            </div>
        </div>
        );
    }
