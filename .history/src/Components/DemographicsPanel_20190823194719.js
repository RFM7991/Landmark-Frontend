...
import { updateRange } from '../Actions/dataRange-actions'
           ...
           <div className={this.props.orientation}>
            <div style={{width: '100hv'}}>
                ...
                <div style={{ textAlign: 'center'}}>
                  ...
                  <button className='map-control_button'  onClick={this.onUpdateRange} value= {'zip'} style={{margin: 'auto', width: '50%', height: '10%', padding: '0'}}>
                    Zip
                </button>
                <button className='map-control_button'  onClick={this.onUpdateRange} value = {'tradeZone'} style={{margin: 'auto', width: '50%', height: '10%', padding: '0'}}>
                    Trade Zone
                </button>
                  <br></br>
                </div>
