    ...
    return (
      ...
      <div className='map_container'>
        {this.state.hasListing && 
          <div style={{ position: 'absolute', top: 0, display: 'flex', flexDirection: 'row',  width: '100%', height: '1em', backgroundColor: 'red'}}>
              <h3>This location has a listing, click here for details</h3>
            </div>
        }
