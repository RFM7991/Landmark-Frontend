          ...
          render={(({match}) => {
            return <div>
                ...
                <header className="App-header" style={{
                  ...
                  <div style={{ zIndex: 2, display: 'flex',backgroundColor: 'red', justifyContent: 'center', alignItems: 'flex-end'}}>
                     <div style={{ zIndex: 2, width: '100px', height: '100%', display: 'flex', backgroundColor: 'purple',}}>
