    ...
    loadAddress = async (address) => {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (addressState.zip == undefined) {
                this.setState({ error : true, errorMessage : "Address is to general, please try another"})
                return 
            }
    ...
    render() {
        ...
        return (
            ...
            <Form style={{ flexDirection : 'row', justifyContent: 'center'}}>
                <Button disbaled={this.state.address == undefined} variant="primary" onClick={this.onHandleSubmit} style={{backgroundColor:'#00d4ff', fontWeight: 'bold'}}>
                    Submit
                </Button>
            </Form>
