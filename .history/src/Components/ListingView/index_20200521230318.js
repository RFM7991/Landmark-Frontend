                            ...
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-around'}}>
                                ...
                                <Table  className="listingDataTable" bordered hover variant="light" >
                                            ...
                                            {Object.entries(data.locationDetails).map(([key, value], i) => {
                                                ...
                                                <tr>
                                                <td>Position</td>
                                                <td className="tableValue">{data.locationDetails.position}</td>
                                                </tr>
                                                <tr>
                                                <td>Tenant Mix</td>
                                                <td className="tableValue" >{data.locationDetails.tenantMixDetails}</td>
                                                </tr>
                                                <tr>
                                                <td>Parking Details</td>
                                                <td className="tableValue" >{data.locationDetails.parkingSpaceDetails}</td>
                                                </tr>
                                                <tr>
                                                <td>Under Construction</td>
                                                <td className="tableValue" >{data.locationDetails.designatedParkingDetails}</td>
                                                </tr>
