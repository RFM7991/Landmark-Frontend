...
class ListingView extends React.Component {
    ...
    getUrl = () => {
        let address = encodeURI(JSON.stringify(this.state.listingData.location.srcformatted))
                    ...
                    <div style={(this.state.listingData == undefined) ? { width: '100%', height: '50vh'} : {display : 'none'}}> 
                        ...
                        { this.state.listingData != undefined &&
                            <div style={{ display: 'flex', flexDirection: 'column',  width: '100%', height: '100%', backgroundColor: 'rgba(255,255,255, 0.7)'}}>
                                ...
                                <div>
                                    <Link to={this.getUrl} style={{color: "whitesmoke", fontWeight: 'bold',  stroke: 'black', strokeWidth: 2, fontFamily: 'Tahoma, Geneva, sans-serif'}}>Go to Map View</Link>
                                </div>
