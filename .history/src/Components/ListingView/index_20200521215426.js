            ...
            <div style={{ width: '100%', height: '100%', backgroundColor: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                    ...
                    <div style={(this.state.listingData == undefined) ? { width: '100%', height: '100vh', display: 'flex', alignItems:'center', justifyContent: 'center'} : {display : 'none'}}> 
                        ...
                        { this.state.listingData != undefined &&
                            ...
                            <h3 style={{ marginLeft: '1em', textAlign : 'left', fontSize: '20px'}}>Listing Summary</h3>
                            <Table  id="listingDataTable" bordered hover variant="light" style={{ textAlign:'left'}}>
                                    
                                        <tbody>
                                            <tr>
                                            <td>Address</td>
                                            <td id="tableValue">{data.location.formatted}</td>
                                            </tr>
                                            <tr>
                                            <td>Asking price</td>
                                            <td id="tableValue">${data.pricingInfo.askingPrice}</td>
                                            </tr>
                                            <tr>
                                            <td>For Sale?</td>
                                            <td id="tableValue">${data.pricingInfo.askingPrice}</td>
                                            ...
                                            <tr>
                                            <td>For Lease?</td>
                                            <td id="tableValue" >{data.contactInfo.forLease}</td>
                                            </tr>
                                        </tbody>
                                    </Table>
