                    ...
                    <div style={(this.state.listingData == undefined) ? { width: '100%', height: '100vh', display: 'flex', alignItems:'center', justifyContent: 'center'} : {display : 'none'}}> 
                        ...
                        { this.state.listingData != undefined &&
                            ...
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-around'}}>
                                ...
                                <h3 style={{  textAlign : 'left', marginLeft: '0.45em', fontSize: '22px', fontWeight: 'bold'}}>Listing Summary</h3>
                                <Table  id="listingDataTable" bordered hover variant="light" style={{ textAlign:'left'}}>
                                            <tbody>
                                                <tr>
                                                <td>Address</td>
                                ...
                                <h3 style={{  textAlign : 'left', marginLeft: '0.45em', fontSize: '22px', fontWeight: 'bold'}}>Location Details</h3>
                                <Table  id="listingDataTable" bordered hover variant="light" style={{ textAlign:'left'}}>
                                            <tbody>
                                                <tr>
                                                <td>Address</td>
                                                ...
                                                <tr>
                                                <td>For Sale?</td>
                                                <td className="tableValue">{data.contactInfo.forSale}</td>
                                                </tr>
                                                <tr>
                                                <td>For Lease?</td>
                                                <td className="tableValue" >{data.contactInfo.forLease}</td>
                                                </tr>
                                            </tbody>
                                </Table>
                            ...
                            <div id="contact_info_panel" style={{ display: 'flex', flex: 1, height: '100%', flexDirection: 'column', alignItems:'center' }}>
                                ...
                                <div style={{ width: '60%',  marginBottom: '0.5em'}}>
                                    <Image src={S3_BASE+ this.state.listingData.photos.contact_photos[0]} fluid roundedCircle/>
                                </div>
                                <p style={{ marginTop: '0.5em', marginBottom: '0.5em', fontWeight: 'bold'}}>{capitalizeFirst(this.state.listingData.contactInfo.relationship)}</p>
                                <div style={{ padding: '0.5em'}}>
                                    <p>{this.state.listingData.contactInfo.ownershipDetails}</p>
                                </div>
                            </div>
                        </div>
                    </div>
