                    ...
                    <div style={(this.state.listingData == undefined) ? { width: '100%', height: '50vh'} : {display : 'none'}}> 
                        ...
                        { this.state.listingData != undefined &&
                            <div style={{ display: 'flex', flexDirection: 'column',  width: '100%', height: '100%', backgroundColor: 'rgba(255,255,255, 0.7)', }}>
                                <div id="listingHeader"style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%', backgroundColor: 'white'}}>
                                    <Link to={this.getUrl} style={{ flexGrow: 1, padding: '0.5em', fontSize: '22px', color: "blue", fontWeight: 'bold',  stroke: 'black', strokeWidth: 2, fontFamily: 'Tahoma, Geneva, sans-serif'}}>Go to Map View</Link>
                                    
                                    <h3 style={{ flex: 3, marginTop : '2%', marginBottom: '2%'}}>{this.state.listingData.location.formatted}</h3>
