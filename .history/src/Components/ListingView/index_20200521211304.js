    ...
    render() {
        ...
        return (
            <div style={{ width: '100%', height: '100%', backgroundColor: 'whitesmoke', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                    ...
                    <div style={(this.state.listingData == undefined) ? { width: '100%', height: '100vh', display: 'flex', alignItems:'center'} : {display : 'none'}}> 
                        ...
                        { this.state.listingData != undefined &&
                            <div style={{ display: 'flex', flexDirection: 'column',  width: '100%', height: '100%', backgroundColor: 'rgba(255,255,255, 0.7)', }}>
                                <div id="listingHeader"style={{paddingTop: '1em', paddingBottom: '0.5em', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%', backgroundColor: 'white'}}>
                                    <Link to={this.getUrl} style={{ flex: 1, marginLeft: '0.5em', fontSize: '22px', color: "blue", fontWeight: 'bold',  stroke: 'black', strokeWidth: 2, fontFamily: 'Tahoma, Geneva, sans-serif'}}>
                                         ...Go to Map View
                                    </Link>
