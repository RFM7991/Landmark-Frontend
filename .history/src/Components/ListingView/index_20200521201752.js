...
class ListingView extends React.Component {
    ...
    getMapOptions = (maps) => {
        ...
        console.log("wtf", maps.MapTypeId.SATELLITE)
        return {
    ...
    render() {
        console.log("list view", this.props.address)
                            ...
                            <div>
                                <div style={{ display : 'flex', backgroundColor: 'cyan' }}>
                                 <div style={{ height: '100vh', width: '100%' }}>
                                        ...
                                        id={'map_list_view'}
                                        onGoogleApiLoaded={({ map, maps }) => this.apiIsLoaded(map, maps, this.state.center)}
