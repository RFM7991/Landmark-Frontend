...
class ListingView extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{ width: '100vh', height: '100%', backgroundColor: 'whitesmoke', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                    ...
                    <div style={(this.state.listingData == undefined) ? { width: '100%', height: '100vh', display: 'flex', alignItems:'center', justifyContent: 'center'} : {display : 'none'}}> 
                        ...
                        { this.state.listingData != undefined &&
                            <div style={{ display: 'flex', flexDirection: 'column',  width: '100%', height: '100%', backgroundColor: 'rgba(255,255,255, 0.7)', }}>
                                ...
                                <div style={{ display : 'flex', backgroundColor: 'whitesmoke', justifyContent:'flex-start' }}>
                                 <div style={{ height: '400px', width: '35%' }}>
                                  ...
                                  <Slideshow width={'50%'} height={'400px'} photos={this.state.listingData.photos.site_photos}/>
                                </div>
