        ...
        return (
            <div style={{ width: '100%', height: '100%', backgroundColor: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                    ...
                    <div style={(this.state.listingData == undefined) ? { width: '100%', height: '100vh', display: 'flex', alignItems:'center', justifyContent: 'center'} : {display : 'none'}}> 
                        ...
                        { this.state.listingData != undefined &&
                            <div style={{ display: 'flex', flexDirection: 'column',  width: '100%', height: '100%', backgroundColor: 'whitesmoke', }}>
                                <div id="listingHeader"style={{paddingTop: '1em', paddingBottom: '0.5em', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%', backgroundColor: 'whitesmoke'}}>
                            ...
                            <h3 style={{ textAlign : 'left', fontSize: '20px'}}>Listing Summary</h3>
                            <Table  bordered hover variant="light" style={{ textAlign:'left'}}>
                                    
                                        <tbody>
                                            <tr>
                                            <td>Address</td>
                                            <td>{data.location.formatted}</td>
                                            </tr>
                                            <tr>
                                            <td>Asking price</td>
                                            <td>${data.pricingInfo.askingPrice}</td>
                                            </tr>
                                            <tr>
                                            <td>For Sale?</td>
                                            <td>{data.contactInfo.forSale}</td>
                                            </tr>
                                            <tr>
                                            <td>For Lease?</td>
                                            <td>{data.contactInfo.forLease}</td>
                                            </tr>
                                        </tbody>
                                    </Table>
