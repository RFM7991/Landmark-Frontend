  ...
  updateRadii() {
   ...
   /*   
      ...
      */
      ...
      points = getPoints(center, 1.0, 10)
      .concat(getPoints(center, 1.5, 10))
      .concat(getPoints(center, 2.2, 30))
      .concat(getPoints(center, 2.6, 10))
      .concat(getPoints(center, 3.0, 40))
      .concat(getPoints(center, 3.4, 10))
      .concat(getPoints(center, 3.8, 50))
      .concat(getPoints(center, 4.2, 10))
      .concat(getPoints(center, 4.628, 50))
      console.log(points)
