    ...
    if (this.state.isCity != undefined) {
      ...
      if (true) {
        //  0.220 : 0.402);
         ...
         const circle3 = renderCircle(440, "#ff0000", this.state.map, this.state.center) // 0.25 miles, 804m
         const circle4 = renderCircle(880, "#ffffff", this.state.map, this.state.center) // 0.25 miles, 804m
