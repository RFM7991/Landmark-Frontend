    ...
    <div style={{ display : 'flex', alignItems: 'center', marginLeft: '2.5%'}}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center',  marginLeft: '10px'}}>
        ...
        <div style={{ display: 'flex', alignContent: 'center'}}>
         ...
         <Form.Control value={this.state.business_type_option} as="select" name="business_type" onChange={this.onBusinessFormChange} style={{width: '150px', textAlign: 'center', display: 'inline', maxMenuHeight: '200px', color: 'whitesmoke'}}>
                        <option>none</option>
                        <option>all</option>
