            ...
            <div style={{width: '100hv'}}>
               ...
               <Accordion defaultActiveKey="0">
                ...
                <Card>
                    ...
                    <Card.Body>
                        <Accordion defaultActiveKey="0">
                        <NestedCard name={"Race"} data={formatCommas(social_data.race)} key_i={"0"}></NestedCard>
                        <NestedCard name={"Education"} data={formatCommas(social_data.education)} key_i={"1"}></NestedCard>
                        <NestedCard name={"Employment"} data={formatCommas(social_data.employment)} key_i={"2"}></NestedCard>
                        <NestedCard name={"Marital Status"} data={formatCommas(social_data.marital_status)} key_i={"3"}></NestedCard>
                        <NestedCard name={"Transportation"} data={formatCommas(social_data.transportation)} key_i={"4"}></NestedCard>
                        </Accordion>
                    </Card.Body>
                    </Accordion.Collapse>
                </Card>
