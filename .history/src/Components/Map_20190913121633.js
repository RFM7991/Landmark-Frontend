       ...
       if (this.state.isCity != undefined) {
         if (this.state.isCity) {
           //  0.220 : 0.402);
            ...
            // get points for lables
            let points = getPoints(center, 0.220) 
         //   let labelCenter1  = { lat: points[0].coords.lat, lng: points[0].coords.lng }
            console.log('RFM', points)
      //     let marker = renderMarker('circle1', labelCenter1, map, '0.0125 miles', GREEN_MARKER)
       //     console.log('RFM', marker)
          ...
          // get points for lables
           ...
           let marker1 = renderMarker('circle1', points[0], map, '0.25 miles', GREEN_MARKER, '0.25')
           marker1.labelContent = '0.25 miles'
