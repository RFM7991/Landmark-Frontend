           ...
           <div className={this.props.orientation} style={{backgroundColor: lightBg, display: 'flex', flexDirection: 'column'}}>
            ...
            <div style={{ flexGrow: 1, overflowY: 'auto', backgroundColor: lightBg}}>
               <Accordion activeKey={this.state.activeKey}>
                ...
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle onClick={this.setState({activeKey: '1'})} as={Card.Header} eventKey="1" style={{color: 'whitesmoke', backgroundColor: darkBg, marginTop: '3px', fontWeight: 'bold'}}>
                    Social
                    </Accordion.Toggle>
