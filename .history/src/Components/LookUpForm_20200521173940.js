            ...
            <div className="lookup-form-block">
                ...
                <div style={{ display: 'flex', flexDirection: 'row'}}>
                    <div style={{ width: '40%', justifyContent: 'flex-start'}}>
                        <Form.Label  style={{color: textPrimary, fontSize: '16px'}}>Your Proposed Business Type</Form.Label>
                    </div>
                    <div style={{ flex: 1, alignItems: 'flex-end', justifyContent: 'center'}}>
                        <Form.Label color="black" style={{color: textPrimary, fontSize: '16px'}}>Address</Form.Label> 
                    </div>
