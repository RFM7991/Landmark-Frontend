    ...
    render() {
        ...
        return (
            <div className="lookup-form-block">
                <br></br>
                {!this.state.error && <p style={{ color: 'red', marginTop: 10, fontSize: 16, visibility : 'hidden'}}>spacer</p>}
                {this.state.error && <p style={{ color: 'red', marginTop: 10, fontSize: 16}}>{this.state.errorMessage}</p>}
