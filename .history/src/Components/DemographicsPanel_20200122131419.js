   ...
   async componentDidUpdate(prevProps) {
    ...
    render() {
        ...
        const NestedCard = ({name, data, key_i}) => {
            ...
            console.log('NESTED CARD', name, total)
            return (
                    ...
                    <Card.Body>
                        ...
                        <tbody>
                            ...
                            <td>Median</td><td>{age_data.median_age + ' yrs'}</td>
                             ...
                             <td>20-29yrs</td><td>{getPercent(age_data.TWENTY + age_data.TWENTYONE + age_data.TWENTYTWO_TWENTY4 + age_data.TWENTYFIVE_TWENTYNINE)}</td>
                             </tr><tr>
