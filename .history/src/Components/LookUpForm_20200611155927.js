    ...
    render() {
        ...
        return (
            ...
            <div style={{ marginTop: '2em', backgroundColor: 'rgba(1,1,1,0.6'}}>
                      <p style={{ fontSize: 18, color: 'whitesmoke', padding: 5, margin: 'auto'}}>*Current locations support New Jersey, the 5 boroughs of New York City, and Long Island, NY, USA</p>
            </div>
        </div>
        );
    }
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <p>
                <span><strong>*Current locations support New Jersey, the 5 boroughs of New York City, and Long Island, NY</strong> </span>   
              <br></br>
