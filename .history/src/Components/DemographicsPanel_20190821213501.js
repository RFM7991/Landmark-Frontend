...
class DemographicsPanel extends React.Component {
   ...
   onUpdateRange(event) {
    ...
    getData() {
        ...
        getTradeZoneStats(this.props.lat, this.props.lng).then((data) => this.setState({tradeZoneData : data}))

        getSocial(ZIP, this.props.cen, (data) => {
    ...
    render() {
        ...
        if (this.state.range == ZIP) {
            ...
            if (this.state.tradeZoneData != null) {
                console.log('TZ DATA', this.state.tradeZoneData)
                social_data = this.state.tradeZoneData
                income_data = this.state.tradeZoneData
                age_data = this.state.tradeZoneData
           ...
           <div className={this.props.orientation}>
            <div style={{width: '100hv'}}>
               ...
               <Accordion defaultActiveKey="0">
                <Card>
                    ...
                    <Card.Body>
                        ...
                        <tbody>
                            ...
                            <td>Median Household Income</td><td>{income_data.income.median}</td>
                            </tr><tr>
                ...
                <NestedCard name={"Income"} data={income_data.income} key_i={"2"}></NestedCard>
                <NestedCard name={"Age"} data={age_data.age} key_i={"3"}></NestedCard>
                </Accordion>
           </div>
        );
    }
