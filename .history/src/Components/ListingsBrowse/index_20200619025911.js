    ...
    render() {
        ...
        return (
            ...
            {!this.state.loading && 
              ...
              {this.state.listings.length > 0 &&  <div style={{ width: '100%', height: '80vh', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: darkBg, color : 'white'}}></div>}
            </div>
       )
    }
 }
