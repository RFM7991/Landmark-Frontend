...
class ListingPreviews extends React.Component {
    ...
    render() {
        ...
        return (
                ...
                <div style={{ width: '100%',  backgroundColor: 'whitesmoke', display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: '0.5em', paddingBottom: '0.5em'}}>
                   <div style={{ display: 'flex'}}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', margin: "0em 1em 0em 1em"}}>
                            ...
                            <Form.Control as="input" name="zip" value={this.state.zip} onChange={this.onBusinessFormChange} style={{flex: 1,  display: 'inline', maxMenuHeight: '200px', }}>
                            </Form.Control> 
                        </div>
                    ...
                    <div style={{ marginRight: '2em'}}>
                        <Button disabled={this.state.zip.length == 0} onPress={this.handleSearch}>
                            Search
                        </Button>
                    </div>
            ...
            {this.state.loading &&  <div style={{ width: '100%', height: '50vh', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: 'yellow'}}> <GridLoader color={"#0892d0"}/> </div>}
              {!this.state.loading && 
