...
class ListingPreviews extends React.Component {
    ...
    render() {
        ...
        return (
                ...
                <div style={{ width: '100%',  backgroundColor: 'whitesmoke', display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: '0.5em', paddingBottom: '0.5em'}}>
                   <div style={{ display: 'flex'}}>
                    ...
                    <div style={{ marginRight: '2em'}}>
                        <Button disabled={this.state.zip.length == 0} onClick={this.handleSearch} variant={'secondart'}>
                            Browse All 
                        </Button>
                    </div>
         ...
         {!this.state.loading &&    <div style={{display : 'flex', width: '100%', justifyContent: 'center', backgroundColor : darkBg}}>
