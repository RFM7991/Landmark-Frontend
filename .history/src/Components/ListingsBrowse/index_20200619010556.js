    ...
    render() {
        ...
        return (
            <div style={{  width: '100%', height: '80%',  display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                <div style={{ width: '100%',  backgroundColor: 'whitesmoke', display: 'flex', alignItems: 'center', paddingTop: '1em', paddingBottom: '1em'}}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', margin: "1em 1em 1em 1em"}}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center',  margin: "0.5em 1em 1em 1em", }}>
                        <span style={{ marginRight: '1em'}}>Distance</span>
