            ...
            <div style={{  width: '100%', height: '80%',  display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                <div style={{ width: '100%',  backgroundColor: 'whitesmoke', display: 'flex', alignItems: 'center', paddingTop: '0.5em', paddingBottom: '0.5em'}}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', margin: "0em 1em 0em 1em"}}>
                        ...
                        <Form.Control value={this.state.business_type_option} as="input" name="zip" onChange={this.onBusinessFormChange} style={{flex: 1, textAlign: 'center', display: 'inline', maxMenuHeight: '200px', }}>
