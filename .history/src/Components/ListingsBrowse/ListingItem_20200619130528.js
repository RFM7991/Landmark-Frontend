...
class ListingItem extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="listingItem" style={{ backgroundColor: lightBg, padding: '1em',  width: '80%', height: '20%',  display: 'flex', flexDirection: 'row', alignItems: 'center', backgroundColor: darkBg}}>
                ...
                <span style={{ fontSize: '24px', padding: '0 1em 0 1em'}}>{this.props.listing.location.formatted}</span></Link>
                    <br></br>
                    <br></br>
