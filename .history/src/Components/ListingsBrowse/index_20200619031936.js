...
class ListingPreviews extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div style={{display : 'flex', width: '100%', justifyContent: 'center', backgroundColor : darkBg}}>
                     <Button disabled={this.state.zip.length == 0} onClick={this.handleSearch} style={{ margin: '1em 1em 1em 1em', borderRadius: 0 }}>
                            Prev
                        </Button>
                        <Button disabled={this.state.zip.length == 0} onClick={this.handleSearch} style={{ margin: '1em 1em 1em 1em', borderRadius: 0 }}>
                            Next
