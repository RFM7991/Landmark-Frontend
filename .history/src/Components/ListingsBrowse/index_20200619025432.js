    ...
    render() {
        ...
        return (
            <div style={{  width: '100%', height: '80%',  display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              ...
              <div id="previewHeader" style={{ width: '100%', backgroundColor: darkBg, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', color: 'white', }}>
                    <h3  style={{  textAlign: 'left', paddingTop: '0.5em', paddingLeft: '0.5em'}}>Recent Listings</h3>
                    {!this.state.loading && <span style={{ paddingTop: '0.5em', paddingRight: '0.5em'}}>{this.state.listings.length} results found</span>}
              </div>
