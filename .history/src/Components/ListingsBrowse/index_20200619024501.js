...
class ListingPreviews extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            {this.state.loading &&  <div style={{ width: '100%', height: '80vh', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: 'yellow'}}> <GridLoader color={"#0892d0"}/> </div>}
              {!this.state.loading && 
