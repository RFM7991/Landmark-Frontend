...
class ListingPreviews extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{  width: '100%', height: '80%',  display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor: darkBg }}>
                <div style={{ width: '100%',  backgroundColor: 'whitesmoke', display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: '0.5em', paddingBottom: '0.5em'}}>
                   <div style={{ display: 'flex'}}>
                    ...
                    <div  style={{ display: 'flex', flexDirection: 'row', backgroundColor: lightBg}}>
              ...
              <div id="previewHeader" style={{ width: '80%', backgroundColor: darkBg, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', color: 'white', }}>
