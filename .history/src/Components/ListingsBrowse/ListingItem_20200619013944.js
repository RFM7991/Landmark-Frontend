...
class ListingItem extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="listingItem" style={{ backgroundColor: lightBg, padding: '1em',  width: '100%', height: '20%',  display: 'flex', flexDirection: 'row', alignItems: 'center'}}>

                <div style={{ width: '300px', height: '250px', backgroundColor : 'rgba(1,1,1,0.5)', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                    <Image 
                ...
                <span style={{ fontSize: '24px'}}>{this.props.listing.location.formatted}</span></Link>
                    <br></br>
                    <br></br>
                    {(this.props.listing.pricingInfo.askingPrice.length > 0) && <p style={{ fontWeight: 'bold' }}>${this.props.listing.pricingInfo.askingPrice}</p>}
