...
import { getTradeZoneStats, getLoadedTradeZoneStats, getTradeZoneBounds, getTradeZoneBlockStats, getZipTradeZoneBounds } from '../Requests/tradezone-requests'
...
class DemographicsPanel extends React.Component {
  ...
  //      .then(res => this.onUpdateTradeZoneBounds(res))
        ...
        await getZipTradeZoneBounds(this.props.isCity, this.props.address.coords)
            .then(res => this.onUpdateTradeZoneBounds(res))
        return; //temp 
    ...
    onUpdateTradeZoneBounds = tradeZone_bounds => {
        console.log('NEW_BOUNDS_DEMO', tradeZone_bounds)
    ...
    render() {
        ...
        console.log('DEMO_RENDER', this.props)
        var social_data =  {
            summary: {
                gender : {},
            },
