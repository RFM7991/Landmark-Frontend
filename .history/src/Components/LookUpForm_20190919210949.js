...
class LookUpForm extends React.Component {
    ...
    onUpdateTradeZoneBounds(tradeZone_bounds) {
        this.props.updateTradeZoneBounds(tradeZone_bounds)
    }
    ...
    async onHandleSubmit() {
        await getTradeZoneBounds(this.state.isCity, this.state.coords)
        .then(res => this.onUpdateTradeZoneBounds(res))
        console.log('lookup props', this.props.tradeZone_bounds)
