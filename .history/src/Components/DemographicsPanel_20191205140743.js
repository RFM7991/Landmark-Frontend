        ...
        const NestedCard = ({name, data, key_i}) => {
            return (
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey={key_i} style={{color: 'whitesmoke', backgroundColor: darkBg, padding: '3px'}}>
                        {name}
                        </Accordion.Toggle>
           ...
           <div className={this.props.orientation} style={{backgroundColor: lightBg, display: 'flex', flexDirection: 'column'}}>
            ...
            <div style={{ flexGrow: 1, overflowY: 'auto', backgroundColor: lightBg}}>
               <Accordion defaultActiveKey="0" >
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey="0" style={{color: 'whitesmoke', backgroundColor: darkBg, marginTop: '3px'}}>
                    General
                    </Accordion.Toggle>
                ...
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey="1" style={{color: 'whitesmoke', backgroundColor: darkBg, marginTop: '3px'}}>
                    Social
                    </Accordion.Toggle>
                ...
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey="0" style={{color: 'whitesmoke', background: darkBg, marginTop: '3px'}}>
                    Age
                    </Accordion.Toggle>
                    <Accordion.Collapse eventKey="0" >
                    <Card.Body>
