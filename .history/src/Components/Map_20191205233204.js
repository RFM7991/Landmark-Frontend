...
onUpdateTransportation = async (transportation) => {
  console.log('ONUPDATE TRANSPORT', 'props', this.props.transportation, 'new', transportation)
  await this.props.onUpdateTransportation(transportation)
}
...
loadNearbySubways = async () => {
  ...
  console.log(this.props.address)
    getNearby(this.props.address, type, async (data, token) => {
        ...
        console.log('loaded', this.props.transportation, transportObj)
