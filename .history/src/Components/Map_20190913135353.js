  ...
  updateRadii() {
    ...
    if (this.state.isCity != undefined) {
      ...
      if (this.state.isCity) {
       ...
       const circle1 = renderCircle(4828, "#00ff00", this.state.map, this.state.center) // 0.25 miles
       const circle2 = renderCircle(8046, "#ffff00", this.state.map, this.state.center) // 0.5 miles
       // to-do cleanup, add label
