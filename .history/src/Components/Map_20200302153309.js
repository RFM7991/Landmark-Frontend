...
class SimpleMap extends Component {
  ...
  updateRadii() {
      if (this.props.isCity) {
        ...
        points = getPoints(this.state.center, 1.804, 1)
        renderComplexMarker('circle2', points[0], this.state.map, '0.5 mi', BLUE_DOT_05, new google.maps.Point(60, 60))
      
        let points1 = getPoints(this.state.center, 0.25, 20)
        let points2 = getPoints(this.state.center, 0.1, 9)
        let points3 = getPoints(this.state.center, 0.1, 9)
        let testPoints = points1.concat(points2)
