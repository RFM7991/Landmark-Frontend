  ...
  updateRadii() {
   ...
   /*   
      ...
      */
      ...
      let points1 = getPoints(this.state.center, 4.0, 30)
      let points2 = getPoints(this.state.center, 3.0, 25)
      let points3 = getPoints(this.state.center, 2.0, 20)
      let points4 = getPoints(this.state.center, 1.0, 15)
      let points5 = getPoints(this.state.center, 0.5, 6)
