  ...
  updateRadii() {
   ...
   /*   
      ...
      */
      ...
      let points1 = getPoints(this.state.center, 4.828, 60)
      let points2 = getPoints(this.state.center, 3.65, 30)
      let points3 = getPoints(this.state.center, 2.7, 20)
      let points4 = getPoints(this.state.center, 1.5, 10)
      let points = points1.concat(points2).concat(points3).concat(points4)
      console.log(points)
      points.forEach((e, i) => {
        renderMarker(i, e, this.state.map, e.lat + ', ' + e.lng, GREEN_MARKER)
      })
