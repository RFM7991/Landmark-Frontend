          ...
          render={(({match}) => {
            return <div>
                ...
                <header className="App-header" style={{
                  ...
                  <div style={{ zIndex: 2, display: 'flex',backgroundColor: 'red'}}>
                     <div style={{ zIndex: 2, width: '40px', height: '100%', display: 'flex', backgroundColor: 'purple', justifyContent: 'center', alignItems: 'center'}}>
