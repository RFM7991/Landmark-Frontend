...
class AboutSection extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{  width: '100%', height: '150vh',  display: 'flex', flexDirection: 'column', alignItems: 'space-between' }}>
                <div style={{ display: 'flex', flex: 2,  flexDirection: 'row', alignItems: 'space-between' }}>
                    <div style={{ display: 'flex', flex: 2, flexDirection: 'column', color: 'white',  justifyContent: 'center', }}>
                        ...
                        <div style={{  height: '80%', display: 'flex', alignItems:'center', justifyContent: 'space-around', flexDirection: 'column'}}>
                            ...
                            <div style={{ fontSize: '16px', paddingLeft: '5em', paddingRight: '5em', backgroundColor: 'rgba(1,1,1,0.7)'}}>
                                <p>
