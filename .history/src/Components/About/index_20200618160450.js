...
class AboutSection extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{  flexWrap: 'wrap', width: '100%', height: '100vh',  display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(1,1,1,0.7)' }}>
