...
class AboutSection extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{  width: '100%', height: '120vh',  display: 'flex', flexDirection: 'column', alignItems: 'space-between', backgroundColor: 'white'}}>
                
                <div style={{display: 'flex', flexDirection: 'column', alignItems: 'space-between', backgroundColor: 'white' }}>
