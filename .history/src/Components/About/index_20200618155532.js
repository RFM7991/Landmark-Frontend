...
class AboutSection extends React.Component {
 ...
 const SidePanel = props => {
     ...
     return (
         <div style={{ margin: '1em', display: 'flex', width: '300px', height: '255px', flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center', backgroundColor: 'whitesmoke', borderRadius: '1em'}}>
