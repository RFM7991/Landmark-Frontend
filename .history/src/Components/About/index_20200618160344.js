...
class AboutSection extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{  flexWrap: 'wrap', width: '100%', height: '100vh',  display: 'flex', flexDirection: 'column', alignItems: 'space-between', justifyContent: 'center', backgroundColor: 'rgba(1,1,1,0.7)' }}>
           
                    <div style={{ display: 'flex', flex: 1, width: '50%', flexDirection: 'column', color: 'white',  justifyContent: 'center', backgroundColor: 'red' }}> 
