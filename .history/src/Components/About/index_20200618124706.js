...
class AboutSection extends React.Component {
 ...
 const SidePanel = props => {
     ...
     return (
         <div style={{ display: 'flex', width: '100%', height: '45%', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'whitesmoke', borderRadius: '1em'}}>
