...
class AboutSection extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{  width: '100%', height: '150vh',  display: 'flex', flexDirection: 'column', alignItems: 'space-between', backgroundColor: 'white'}}>
                <div style={{ display: 'flex', flex: 2,  flexDirection: 'row', alignItems: 'space-between', backgroundColor: 'red'}}>
                ...
                <div style={{flex: 1, backgroundColor: 'blue', display: 'flex', justifyContent: 'center'}}>
                    <div style={{ width: '100%', height: '75%', display: 'flex', justifyContent: 'space-around', alignItems: 'space-around', backgroundColor: 'green', color: 'black' }}>
                        <InfoPanel title="Universal" subtitle="test test test"/> 
                        <InfoPanel title="Custom"/>
                        <InfoPanel title="Collaborative"/>
                    </div>
                </div>
 ...
 const InfoPanel = props => {
    ...
    return (
        <div style={{ display: 'flex', width: '25%', height: '48%', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
            <div style={{ flex: 3, display: 'flex',  flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center', backgroundColor: 'whitesmoke', borderRadius: '1em'}}>
                <div style={{ flex: 2,  display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
                <h3>{props.title}</h3>
                </div>
