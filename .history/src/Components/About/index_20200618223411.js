                    ...
                    <div style={{ display: 'flex', flex: 1, width: '75%', flexDirection: 'column', color: 'white',  justifyContent: 'center', }}> 
                      ...
                      <header  style={{
                            ...
                            opacity: '1',
                                 ...
                                 <div style={{ display: 'flex', flex: 1, width: '100%', height: '100%', flexDirection: 'column', color: 'white',  justifyContent: 'center', backgroundColor: 'rgba(1,1,1,0.4)'}}> 
                                  <h3 style={{  fontWeight: 'bold', fontSize: '42px', textAlign: 'left', marginLeft: '1.5em', marginBottom: '2em'  }}>Small Businesses</h3>
                                    <div style={{ fontSize: '16px', paddingLeft: '5em', paddingRight: '5em', marginBottom: '5em', backgroundColor: 'red' }}>
