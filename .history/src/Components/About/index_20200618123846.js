    ...
    render() {
        ...
        return (
            <div style={{  width: '100%', height: '100vh',  display: 'flex', flexDirection: 'row', alignItems: 'space-between', backgroundColor: 'white'}}>
                ...
                <div style={{ display: 'flex', flex: 1, alignItems: 'center', flexDirection: 'column', backgroundColor: 'blue', color: 'black',  }}>
                    <div style={{ width: '70%', height: '80%', justifyContent: 'space-around'}}>
