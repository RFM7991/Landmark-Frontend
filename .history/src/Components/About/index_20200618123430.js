...
class AboutSection extends React.Component {
        ...
        return (
            <div style={{  width: '100%', height: '100vh',  display: 'flex', flexDirection: 'row', alignItems: 'space-between', backgroundColor: 'white'}}>
                <div style={{ display: 'flex', flex: 1, flexDirection: 'column', color: 'black',  justifyContent: 'center', backgroundColor: 'green'}}>
                    ...
                    <div style={{ backgroundColor: 'purple', height: '80%', display: 'flex', alignItems:'center', justifyContent: 'space-around', flexDirection: 'column'}}>
                ...
                <div style={{ flex: 1, backgroundColor: 'blue', color: 'black' }}>
 ...
 const SidePanel = props => {
     ...
     return (
         <div style={{ display: 'flex', flex: 1, flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center', backgroundColor: 'whitesmoke', borderRadius: '1em'}}>
             <h3>{props.title}</h3>
             <div>
                 <p>{props.content}</p>
             </div>
