        ...
        return (
            <div style={{  width: '100%', height: '100vh',  display: 'flex', flexDirection: 'row', alignItems: 'space-between', backgroundColor: 'white'}}>
                ...
                <div style={{ display: 'flex', flex: 1, alignItems: 'center', justifyContent: 'center', flexDirection: 'column', backgroundColor: 'blue', color: 'black',  }}>
                    <div style={{ width: '60%', height: '90%', justifyContent: 'space-between', display: 'flex', flexDirection: 'column', backgroundColor: 'red'}}>
                        <InfoPanel title={"Buyers"} content={"Consequat interdum varius sit amet mattis vulputate enim. Pellentesque habitant morbi tristique senectus et netus et. Tellus rutrum tellus pellentesque eu tincidunt tortor aliquam nulla facilisi. Rhoncus urna neque viverra justo. Tortor at risus viverra adipiscing at in tellus. Pulvinar elementum integer enim neque volutpat ac tincidunt vitae semper. "}/>

                        <InfoPanel title={"Brokers"} content={"Consequat interdum varius sit amet mattis vulputate enim. Pellentesque habitant morbi tristique senectus et netus et. Tellus rutrum tellus pellentesque eu tincidunt tortor aliquam nulla facilisi. Rhoncus urna neque viverra justo. Tortor at risus viverra adipiscing at in tellus. Pulvinar elementum integer enim neque volutpat ac tincidunt vitae semper. "}/>
                    </div>
                </div>
            </div>
       )
 ...
 const InfoPanel = props => {
     ...
     return (
         <div style={{ display: 'flex', width: '100%', height: '48%', flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center', backgroundColor: 'whitesmoke', borderRadius: '1em'}}>
             <div style={{ flex: 2, backgroundColor: 'green', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
                <h3>{props.title}</h3>
             </div>
             <div style={{ flex: 5, backgroundColor: 'yellow', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
