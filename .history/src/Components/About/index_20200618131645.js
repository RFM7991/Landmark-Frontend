...
class AboutSection extends React.Component {
 ...
 const InfoPanel = props => {
    ...
    return (
        <div style={{ display: 'flex', width: '20%', height: '48%', flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center', backgroundColor: 'whitesmoke', borderRadius: '1em'}}>
            <div style={{ flex: 2,  display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
               <h3>{props.title}</h3>
            </div>
