...
class AboutSection extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{  width: '100%', height: '150vh',  display: 'flex', flexDirection: 'column', alignItems: 'space-between', backgroundColor: 'rgba(1,1,1,0.7)' }}>
                ...
                <div style={{flex: 1, backgroundColor: 'blue', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: lightBg, marginBottom: '1em'}}>
 ...
 const InfoPanel = props => {
    ...
    return (
        <div style={{ display: 'flex', width: '250px', height: '250px', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', margin: '1em'}}>
