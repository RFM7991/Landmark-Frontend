...
class AboutSection extends React.Component {
        ...
        return (
            <div style={{  width: '100%', height: '150vh',  display: 'flex', flexDirection: 'column', alignItems: 'space-between', backgroundColor: 'rgba(1,1,1,0.7)' }}>
                ...
                <div style={{flex: 1, backgroundColor: 'blue', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: lightBg}}>
                    <div style={{ width: '100%', height: '75%', display: 'flex', justifyContent: 'space-around', alignItems: 'center',  color: 'black' }}>
 ...
 const SidePanel = props => {
     ...
     return (
         <div style={{ display: 'flex', width: '100%', height: '40%', flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center', backgroundColor: 'whitesmoke', borderRadius: '1em'}}>
