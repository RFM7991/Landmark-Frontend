...
class AboutSection extends React.Component {
        ...
        return (
            <div style={{  width: '100%', height: '150vh',  display: 'flex', flexDirection: 'column', alignItems: 'space-between', backgroundColor: 'white'}}>
                ...
                <div style={{flex: 1, backgroundColor: 'blue', display: 'flex', justifyContent: 'center'}}>
                    <div style={{ width: '100%', height: '75%', display: 'flex', justifyContent: 'space-around' }}>
                        <InfoPanel /> 
                        <InfoPanel />
                        <InfoPanel />
                    </div>
 ...
 const InfoPanel = props => {
    ...
    return (
        <div style={{ display: 'flex', width: '50%', height: '48%', flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center', backgroundColor: 'whitesmoke', borderRadius: '1em'}}>
            <div style={{ flex: 2,  display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
               <h3>{props.title}</h3>
            </div>
