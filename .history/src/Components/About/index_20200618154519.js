...
class AboutSection extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{  width: '100%', height: '150vh',  display: 'flex', flexDirection: 'column', alignItems: 'space-between', backgroundColor: 'rgba(1,1,1,0.7)' }}>
                <div style={{ display: 'flex', flex: 2,  flexDirection: 'row', alignItems: 'space-between' }}>
                    ...
                    <div style={{ display: 'flex', flex: 2, alignItems: 'center', justifyContent: 'center', flexDirection: 'column',  color: 'black',  }}>
                        <div style={{ width: '55%', height: '90%', justifyContent: 'space-between', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{flex: 1, flexWrap: 'wrap', backgroundColor: 'blue', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', backgroundColor: lightBg, color: 'black'}}>
 ...
 const InfoPanel = props => {
    ...
    return (
        <div style={{ display: 'flex', flex: 1, flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginLeft: '1em', marginRight: '1em'}}>
