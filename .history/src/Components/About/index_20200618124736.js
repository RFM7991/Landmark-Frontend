...
class AboutSection extends React.Component {
        ...
        return (
            <div style={{  width: '100%', height: '100vh',  display: 'flex', flexDirection: 'row', alignItems: 'space-between', backgroundColor: 'white'}}>
                ...
                <div style={{ display: 'flex', flex: 1, alignItems: 'center', justifyContent: 'center', flexDirection: 'column', backgroundColor: 'blue', color: 'black',  }}>
                    <div style={{ width: '70%', height: '90%', justifyContent: 'space-between', display: 'flex', flexDirection: 'column', backgroundColor: 'red'}}>
 ...
 const SidePanel = props => {
     ...
     return (
         <div style={{ display: 'flex', width: '100%', height: '47.5%', flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center', backgroundColor: 'whitesmoke', borderRadius: '1em'}}>
