...
class ListingPreviews extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{ width: '100%', height: '80%', backgroundColor: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
               
                   
                <MultiSlideshow width={'60%'} height={'400px'} data={this.state.listings}/>
