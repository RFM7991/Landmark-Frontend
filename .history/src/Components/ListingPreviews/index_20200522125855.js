...
class ListingPreviews extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{ backgroundColor: darkBg, width: '100%', height: '80%',  display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
               
                <div style={{ width: '100%', backgroundColor: 'whitesmoke' }}>
                    <h3 style={{ color: 'white', textAlign: 'left', marginLeft: '0.5em'}}>Recent Listings</h3>
                </div>
