...
class ListingPreviews extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div className="d-block w-100" style={{backgroundColor : lightBg, height: this.props.height}} onMouseOver={this.handleHover} onMouseLeave={this.handleMouseOut}> 
             <div style={{ height: '85%'}}>        
                <Image 
                id="noBlur"
                ...
                alt="First slide"
                fluid
                style={{  height: '90%', opacity: (this.state.hovering) ? 0.6 : 1.0 }}
                />
            </div>   
