    ...
    render() {
        ...
        return (
            <div style={{  width: '100%', height: '80%',  display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                ...
                <div id="previewHeader" style={{ paddingBottom: '0.5em',width: '100%', backgroundColor: lightBg, display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                    <h3  style={{ color: 'white', textAlign: 'left', paddingTop: '0.5em', paddingLeft: '0.5em'}}>Recent Listings</h3>
                    <Link to={"/listings/browse"} style={{ paddingTop: '0.5em', paddingRight: '0.5em', color: 'white' }}>See More...</Link>
                </div>
