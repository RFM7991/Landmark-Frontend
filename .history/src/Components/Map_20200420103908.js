...
import { renderCircle, renderMarker, renderZMarker, renderComplexMarker, renderInfoContent, BLUE_MARKER, YELLOW_MARKER, GREEN_MARKER, RED_MARKER, BLUE_DOT_05, YELLOW_DOT_25, YELLOW_DOT_3, BLUE_DOT_5 } from './GoogleMapComponents'
...
generateHeading = () => {
 ...
 //  console.log('map props', this.props)
    const apiIsLoaded = (map, maps, center) => {
      this.state.map = map
      if (!this.props.address.place.types.includes('establishment')) {
        let yourBusinessMarker = renderZMarker('your_business', center, map, 'Your Business', BLUE_MARKER, 100000)
        yourBusinessMarker.set
