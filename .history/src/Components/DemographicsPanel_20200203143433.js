...
class DemographicsPanel extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            zipDisabled : false,
            zipHeader : 'Zip',
            accordianKeys : { ZIP:  ['0', '0', '0', '0'], TRADE_ZONE :  ['0', '0', '0', '0']}
         }
           ...
           <div className={this.props.orientation} style={{backgroundColor: lightBg, display: 'flex', flexDirection: 'column'}}>
            ...
            <div style={{ flexGrow: 1, overflowY: 'auto', backgroundColor: lightBg}}>
               <Accordion defaultActiveKey='0'>
                ...
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey={this.state.accordianKeys[this.props.data_range][1]} style={{color: 'whitesmoke', backgroundColor: darkBg, marginTop: '3px', fontWeight: 'bold'}}>
                    Social
                    </Accordion.Toggle>
                ...
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey={this.state.accordianKeys[this.props.data_range][1]} style={{color: 'whitesmoke', background: darkBg, fontWeight: 'bold'}}>
                    Household Income
                    </Accordion.Toggle>
                ...
                <Card style={{backgroundColor: lightBg}}>
                    <Accordion.Toggle as={Card.Header} eventKey={this.state.accordianKeys[1]} style={{color: 'whitesmoke', background: darkBg, fontWeight: 'bold'}}>
                    Age
                    </Accordion.Toggle>
