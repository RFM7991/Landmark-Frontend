...
generateHeading = () => {
 ...
 //  console.log('map props', this.props)
  ...
  <div className='map-control_bar'>
    ...
    <Button style={{ fontSize: 12, marginRight: '0.5em',}} onClick={this.props.runJoyRideTutorial}>Help</Button>
      <Button style={{ fontSize: 12, marginRight: '0.5em'}} variant="light" onClick={this.onHandleCenter}> 
        Center
      </Button>
