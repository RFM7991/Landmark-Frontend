  ...
  updateRadii() {
   ...
   /*   
      ...
      */
      ...
      let points2 = getPoints(this.state.center, 3.8, 40)
      let points3 = getPoints(this.state.center, 2.5, 30)
      let points4 = getPoints(this.state.center, 1.7, 20)
      let points5 = getPoints(this.state.center, 1, 10)
