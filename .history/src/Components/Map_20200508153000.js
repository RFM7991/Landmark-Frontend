...
navigateToListing = () => {
  console.log("navigateToListing")
  let url = '/' + this.state.listing.listingId
 ...
 //  console.log('map props', this.props)
  ...
  <div>
      {this.state.hasListing && 
        <div style={{ display: 'flex', flexDirection: 'row',  alignItems: 'center', justifyContent: 'center', width: '100%', height: '2em', backgroundColor: 'whitesmoke'}}>
            <div><span>This location has a listing, click </span> <span style={{ color : "blue"}} onClick={this.generateHeading.navigateToListing}>here</span> <span> for details</span></div>
          </div>
      }
