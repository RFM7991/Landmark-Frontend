    ...
    render() {
        ...
        return (
            <Navbar style={{background: navBg}} expand="lg">
                <Navbar.Brand href="/Landmark-Frontend/" style={{color: "whitesmoke", fontWeight: 'bold',  stroke: 'black', strokeWidth: 2, fontFamily: 'Tahoma, Geneva, sans-serif'}}>Landmark</Navbar.Brand>
