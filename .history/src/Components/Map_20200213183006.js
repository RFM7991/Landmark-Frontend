...
generateHeading = () => {
 ...
 //  console.log('map props', this.props)
  ...
  <div className='map-control_bar'>
    ...
    <Button style={{ fontSize: 12}} onPress={this.props.runJoyRideTutorial}>Help</Button>
      <Button style={{ fontSize: 12}} variant="light" onClick={this.onHandleCenter}> 
        Center
      </Button>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center',  marginTop: '2px', marginLeft: '10px'}}>
