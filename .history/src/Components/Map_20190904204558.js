...
import { getNearby, getPages, getPhoto, getNearbyPlaces} from '../Requests/map-requests' 
import '../css/App.css';
...
import { renderCircle, renderMarker, renderInfoContent, BLUE_MARKER, YELLOW_MARKER, GREEN_MARKER } from './GoogleMapComponents'
