    ...
    if (this.props.ready) {
      ...
      <div style={{display: 'flex',  alignItems: 'center', justifyContent: 'center'}}>
       ...
       <SimpleMap height={'25vh'} address={this.props.address} center={this.props.address.coords} zoom={15} business_type={this.props.business_type}/>
          ...
          <img src= {'https://maps.googleapis.com/maps/api/streetview?size=600x300&location=46.414382,10.013988&heading=151.78&pitch=-0.76&key='+ GOOGLE_KEY+'&signature=YOUR_SIGNATURE'}/>
        </div>
    </div>
      var panel = 
       <div>
