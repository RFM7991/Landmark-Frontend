            ...
            <div style={{flexDirection: 'column', alignItems: 'flex-start', padding: '1.5em', width: '100%', backgroundColor: lightBg}}>
                ...
                <div>
                    ...
                    enlargedImagePosition='beside'
                     />
                       <a  style={{ textAlign: 'center'}} href="https://upload.wikimedia.org/wikipedia/commons/3/3a/Official_New_York_City_Subway_Map_vc.jpg" target="_blank" >See full size</a>
                     </div>
                }
