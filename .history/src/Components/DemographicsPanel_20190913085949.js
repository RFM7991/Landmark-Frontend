...
class DemographicsPanel extends React.Component {
   ...
   onUpdateDataRange(event) {
    ...
    if (val === 'zip') {
        ...
        this.setState({ currentData : this.state.zipStats})
    }
    else if (val == 'tradeZone') {
        this.props.onUpdateDataRange(TRADE_ZONE)
        this.setState({ currentStats : this.state.tradeZoneStats})
    }
   }
     ...
     getData () {
        let zipStats = getAllStats(this.props.lat, this.props.lng, 'zip').then(data => this.setState({ zipStats : zipStats, currentStats : zipStats}))
        let tradeZoneStats =  getAllStats(this.props.lat, this.props.lng, 'tradezone').then(data =>   this.setState({tradeZoneStats : tradeZoneStats}))
        console.log(zipStats, tradeZoneStats)
        /*
        // zip
    ...
    render() {
        ...
        if (this.state.zipD != null) {
            console.log('set data', this.state.currentData)
            social_data = this.state.currentData.social
        }
