        ...
        return (
            <div className="lookup-form-block">
                ...
                <div style={{ width: '100%',  display: 'flex'}}>
                    <div style={{ flex: 1,flexDirection: 'row',  justifyContent: 'center', alignItems: 'center', backgroundColor: 'red' }}>
                        <Form.Label color="black" style={{color: textPrimary, fontSize: '22px', backgroundColor: 'green'}}>Address</Form.Label> 
                    </div>
