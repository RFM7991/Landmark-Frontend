...
class DemographicsPanel extends React.Component {
   ...
   async componentDidUpdate(prevProps) {
       if (!this.state.statsLoaded && this.state.tradeZoneStats == null) {
    ...
    async getTradeZoneData() {
        console.log('GET TZ DATA', this.props.address.isNewEntry, this.props.tradeZone_bounds == undefined)
        ...
        if (this.props.address.isNewEntry) {
            ...
            let data = await getLoadedTradeZoneStats(this.props.address.place.place_id)
