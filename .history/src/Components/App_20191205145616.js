          ...
          render={(({match}) => {
            return <div>
                ...
                <header className="App-header" style={{
                  ...
                  <div style={{position: 'absolute', width: '100%', height: '100%', backgroundColor: 'rgba(26,28,41, 0.5)', zIndex: 1}}></div>
                  <h1 style={{zIndex: 2, fontSize: '56px', fontWeight: 'bold', fontFamily: 'Tahoma, Geneva, sans-serif' }}>Landmark</h1>
                  <h3 style={{zIndex: 2}}>Professional Grade Commercial Real Estate Consultation for All</h3>
                    <LookUpForm/>
                </header>
              </div>
              <Footer/>
