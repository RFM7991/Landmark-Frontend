...
generateHeading = () => {
 ...
 //  console.log('map props', this.props)
  ...
  <div className='map-control_bar'>
    ...
    <Button style={{ fontSize: 12, width: '15%', marginRight: '1em', textAlign: 'center'}} onClick={this.props.runJoyRideTutorial}>Help</Button>
      <Button style={{ fontSize: 12, marginRight: '1em'}} variant="light" onClick={this.onHandleCenter}> 
        Center
      </Button>
