                    ...
                    <Card.Body>
                        ...
                        <tbody>
                            ...
                            <td>Total households</td><td>{formatCommas(income_data.total_households)}</td>
                             ...
                             <td>0-35k</td><td>{getPercent(income_data.median)}</td>
                             </tr><tr>
                             <td>35-50k</td><td>{getPercent(income_data.median)}</td>
                             </tr><tr>
                             <td>50-75k</td><td>{getPercent(income_data.median)}</td>
                             </tr><tr>
                             <td>75-100k</td><td>{getPercent(income_data.median)}</td>
                             </tr><tr>
                             <td>100-200k</td><td>{getPercent(income_data.median)}</td>
                             </tr><tr>
                             <td>200k+</td><td>{getPercent(income_data.median)}</td>
                             </tr>
                        </tbody>
                        </Table>
                    </Card.Body>
