                ...
                <div>
                    <Form>
                        <Form.Group controlId="exampleForm.ControlTextarea1">
                            ...
                            <Form.Control value={this.state.body} as="textarea" placeholder='Enter comments here'rows="3" />
                        </Form.Group>
                        <Button variant='primary' onChange={this.handleFormChange} onClick={this.handleSubmit} style={{backgroundColor:'#00d4ff', fontWeight: 'bold'}}>
                            Submit
                        </Button>
                    </Form>
                </div>
