            ...
            return <div>
                ...
                <header className="App-header" style={{
                  ...
                  <h3 style={{zIndex: 2}}>Commercial Real Estate Consultation for All</h3>
                    <LookUpForm/>
                    <div style={{ paddingTop: '2ems', backgroundColor: 'rgba(255,255,255,0.6'}}>
                      <p>*Current locations support New Jersey, the 5 boroughs of New York City, and Long Island</p>
                    </div>
                </header>
              </div>
              <Footer/>
