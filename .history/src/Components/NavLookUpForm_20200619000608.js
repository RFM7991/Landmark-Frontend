...
/*
    ...
    render() {
        ...
        return (
            <div style={{ position: 'absolute',  width: '100%', display: 'flex', justifyContent:'center', alignItems: 'center', zIndex: 1000, }}>
            ...
            <Form style={{   position: 'absolute', flexDirection : 'row', justifyContent: 'center', }}>
