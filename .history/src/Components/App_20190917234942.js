    ...
    if (this.props.ready) {
      ...
      <div style={{display: 'flex',  alignItems: 'center', justifyContent: 'center'}}>
        <StaticGoogleMap size="600x200"  
          ...
          <img src= {'https://maps.googleapis.com/maps/api/streetview?size=600x300&location=46.414382,10.013988&heading=151.78&pitch=-0.76&key='+ GOOGLE_KEY +'&signature=lpkXmFKRjuqOM9YXgLIrGRlPWIA='}/>
          />
        </div>
    </div>
