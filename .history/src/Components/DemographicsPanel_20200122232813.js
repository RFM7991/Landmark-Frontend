...
class DemographicsPanel extends React.Component {
   ...
   async componentDidUpdate(prevProps) {
    ...
    loadNewTradeZoneStats = async () => {
        console.log('load new', typeof(this.props.tradeZone_bounds))
        ...
        console.log('NEW TZ', this.props.data_range, data)
        // set internal state
        ...
        let res = await createTradeZoneStats(this.props.address.place.place_id, data, this.props.data_range)
