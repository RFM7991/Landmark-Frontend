...
class DoughnutChart extends Component {
	...
	getDataPoints = () => {
		...
		switch (this.props.title) {
			...
			case INCOME: 
				...
				console.log('METHOD', incomeStats)
	...
	render() {
		console.log('DOUGHNUTS', this.props.data_range == TRADE_ZONE && this.props.tradezone == undefined)
		...
		<div style={{ width: '20rem', height: '50%', marginRight: '5rem', marginLeft: '5rem'}}>
			...
			{this.props.data_range == ZIP && this.props.stats.zip == undefined && <Loader/>}
			{this.props.data_range == TRADE_ZONE && this.props.stats.tradezone == undefined && <Loader/>}
		</div>
		);
	}
}
