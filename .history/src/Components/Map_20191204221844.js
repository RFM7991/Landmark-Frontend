...
loadNearbySubways = () => {
  ...
  getNearby(this.props.address, type, async (data, token) => {
      ...
      console.log('REASON', this.props.transportation == '')
      if (this.props.transportation == '') { let transportObj = {} }
      else { let transportObj = this.props.transportObj}
      //8  let transportObj = (this.props.transportation = '') ? this.props.transportation : {}
      
      transportObj.subways = object
