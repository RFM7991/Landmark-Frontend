        ...
        return (
            <div style={{ display: 'flex', alignItems: 'flex-start',  flexDirection: 'column', padding: '20px' }}>
                ...
                <div style={{ borderBottom: '1px solid rgb(31,33,48)', width: '20%', textAlign: 'left', marginTop: '3em' }}>       
                    ...
                    <br></br>
                    <div style={{ display: 'flex', height: '210px', width: '100%', overflowX: 'auto', flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                        <div style={{ width: '225px', height: '100%', backgroundColor: 'cyan'}}></div>
                        <div style={{ width: '225px', height: '100%', backgroundColor: 'red'}}></div>
                        <div style={{ width: '225px', height: '100%', backgroundColor: 'blue'}}></div>
