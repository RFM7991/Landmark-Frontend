                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column', marginLeft: '24px', marginTop: '10px' }}>
                    <form>
                        ...
                        <div className="inputGroup">
                            <label>yes<input type="checkbox" checked={this.state.forSale } name="forSale" value={'yes'} onChange={this.handleCheckChange} /></label>
                            <label>no<input type="checkbox" checked={!this.state.forSale } name="forSale" value={'no'} onChange={this.handleCheckChange} /></label>
                        </div>

                        <strong>Is the property for lease?</strong>
                        <div className="inputGroup">
                            <label>yes<input type="checkbox" checked={ this.state.forLease } name="forLease" value={'yes'} onChange={this.handleCheckChange} /></label>
                            <label>no<input type="checkbox" checked={!this.state.forLease } name="forLease" value={'no'} onChange={this.handleCheckChange} /></label>
                        </div>
