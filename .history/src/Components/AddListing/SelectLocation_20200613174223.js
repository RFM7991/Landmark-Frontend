    ...
    render() {
        return (
            <div style={{ display: 'flex',  height: '80vh', alignItems: 'center', justifyContent: 'center',  flexDirection: 'column', padding: '20px' }}>
                ...
                <div style={{ flex: 1, flexDirection: 'row', alignItems: 'center', width: '80%'}}>
                    <div style={{ flex: 1, backgroundColor: 'red', width: '50%'}}> <AutoCompleteBar addressFunction={this.selectAddress}/></div>
               
                    <div style={{ flex: 1, width: '50%'}}>  <Button variant="primary" onClick={this.handleSubmit} disabled={this.state.address == undefined}
                        style={{backgroundColor:'#00d4ff', fontWeight: 'bold', alignSelf: 'center',  }}>
                        Submit
                    </Button> </div>
