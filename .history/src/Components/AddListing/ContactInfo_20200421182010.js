            ...
            <div style={{ display: 'flex', alignItems: 'flex-start',  flexDirection: 'column', padding: '20px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column', marginLeft: '24px', marginTop: '10px' }}>
                    <form>
                        ...
                        <div className="inputGroup">
                            <label>yes<input type="checkbox" value={this.state.value} name="forLease" value={'true'} onChange={this.handleCheckChange} /></label>
                            <label>no<input type="checkbox" value={this.state.value} name="forLease" value={'false'} onChange={this.handleCheckChange} /></label>
                        </div>
