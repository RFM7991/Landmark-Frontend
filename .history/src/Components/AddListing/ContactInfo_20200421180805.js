                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column', marginLeft: '24px', marginTop: '10px' }}>
                    <form>
                        ...
                        <div className="inputGroup">
                            <label>yes<input type="checkbox" name="forSale" value={this.state.value} onChange={this.handleChange} /></label>
                            <label >no<input type="checkbox" name="forSale" value={this.state.value} onChange={this.handleChange} /></label>
                        </div>
