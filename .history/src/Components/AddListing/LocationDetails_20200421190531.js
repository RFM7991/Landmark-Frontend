            ...
            <div style={{ display: 'flex', alignItems: 'flex-start',  flexDirection: 'column', padding: '20px' }}>            
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column', marginLeft: '24px', marginTop: '10px' }}>
                    ...
                    <div class="form-group files color">
                        ...
                        <div className="inputGroup">
                            <label>yes<input type="checkbox" checked={this.state.hasZoning =="yes" } name="hasOccupancyCert" value={'yes'} onChange={this.handleChange} /></label>
                            <label>no<input type="checkbox" checked={this.state.hasZoning == "no" } name="hasOccupancyCert" value={'no'} onChange={this.handleChange} /></label>
                        </div>
