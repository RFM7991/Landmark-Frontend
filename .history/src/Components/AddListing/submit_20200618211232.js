    ...
    render() {
        ...
        return (
            <div style={{ display: 'flex', alignItems: 'flex-start',  flexDirection: 'column', padding: '20px' }}>
                ...
                <h3 style={{ fontSize: '18px', marginBottom: '0.5em'}}>Cover Photos: {this.props.photos.cover_photos.length == 0 && <span style={{ color: 'red', fontSize: '16px'}}>No cover photos provided</span>}</h3> 
                {
                    <div style={{ display: 'flex',  height: '270px', width: '100%',  overflowX: 'auto', flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgb(242,242,242)' }}>
            ...
            <h3 style={{ fontSize: '18px', marginBottom: '0.5em', marginTop: '1em'}}>Site Photos:</h3>
                {
                    <div style={{ display: 'flex',  height: '270px', width: '100%',  overflowX: 'auto', flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgb(242,242,242)' }}>
