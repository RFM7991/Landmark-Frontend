                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column', marginLeft: '24px', marginTop: '10px' }}>
                    <form>
                        ...
                        <div className="inputGroup">
                            <label>yes<input type="checkbox" checked={this.state.forSale =="yes" } name="forSale" value={'yes'} onChange={this.handleCheckChange} /></label>
                            <label>no<input type="checkbox" checked={this.state.forSale == "no" } name="forSale" value={'no'} onChange={this.handleCheckChange} /></label>
                        </div>

                        <strong>Is the property for lease?</strong>
                        <div className="inputGroup">
                            <label>yes<input type="checkbox" checked={ this.state.forLease == "yes" } name="forLease" value={'yes'} onChange={this.handleCheckChange} /></label>
                            <label>no<input type="checkbox" checked={this.state.forLease == "no" } name="forLease" value={'no'} onChange={this.handleCheckChange} /></label>
                        </div>

                        <strong>What is your relationship to this property?</strong>
                        <div className="inputGroup">
                            <label>I am the broker<input type="checkbox" checked={this.state.relationship == 'broker'} value={'broker'} onChange={this.handleChange} /></label>
