                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column', marginLeft: '24px', marginTop: '10px' }}>
                    <form>
                        ...
                        <div className="inputGroup">
                            ...
                            <label>I am the landlord<input type="checkbox" checked={this.state.relationship == 'landlord'} value={'landlord'} onChange={this.handleChange} /></label>
                            <label>other<input type="checkbox" checked={this.state.relationship == 'other'} value={'other'} onChange={this.handleChange} /></label>
                        </div>
