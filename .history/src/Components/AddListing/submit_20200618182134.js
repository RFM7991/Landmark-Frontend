        ...
        return (
            <div style={{ display: 'flex', alignItems: 'flex-start',  flexDirection: 'column', padding: '20px' }}>
                ...
                <div style={{ borderBottom: '1px solid rgb(31,33,48)', width: '20%', textAlign: 'left', marginTop: '3em' }}>       
                    ...
                    <h3 style={{ fontSize: '22px'}}>Contact Photos:</h3>
                    <br></br>
                    <div style={{ display: 'flex',  height: '230px', width: '100%',  overflowX: 'auto', flexDirection: 'row', alignItems: 'center', }}>
                        <div style={{ flexGrow: 1, minWidth: '225px', height: '225px', backgroundColor: 'cyan'}}></div>
                        <div style={{ flexGrow: 1, minWidth: '225px', height: '100%', backgroundColor: 'red'}}></div>
                        <div style={{ flexGrow: 1, minWidth: '225px', height: '100%', backgroundColor: 'blue'}}></div>
                        <div style={{ flexGrow: 1, minWidth: '225px', height: '100%', backgroundColor: 'cyan'}}></div>
                        <div style={{ flexGrow: 1, minWidth: '225px', height: '100%', backgroundColor: 'red'}}></div>
                        <div style={{ flexGrow: 1, minWidth: '225px', height: '100%', backgroundColor: 'blue'}}></div>
                        <div style={{ flexGrow: 1, minWidth: '225px', height: '100%', backgroundColor: 'cyan'}}></div>
                        <div style={{ flexGrow: 1, minWidth: '225px', height: '100%', backgroundColor: 'red'}}></div>
                        ...
                        {this.props.photos.contact_photos.map((file, i) => {
                            return (
                                <div style={{ width: '225px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: 'red'}}>
