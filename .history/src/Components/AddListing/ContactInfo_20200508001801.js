                    ...
                    <form>
                        ...
                        <div>
                            {this.props.photos.map((e, i) => {
                                return (
                                    <div style={{ width: '100%', display : 'flex', flexDirection : 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: 'green'}}>
                                        <Button variant="danger" onClick={() => this.removePhoto(i)} 
                                            style={{ alignSelf: 'center', fontSize: 12 }}>
                                           X
                                        </Button>
                                        <div style={{ textAlign: 'center', alignSelf: 'center', backgroundColor: 'yellow'}}>{e.name}</div>
                                    </div>
                                )
                            })}
