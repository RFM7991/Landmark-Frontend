                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column', marginLeft: '24px', marginTop: '10px' }}>
                    <form>
                        ...
                        <div className="inputGroup">
                            <label>yes<input type="checkbox" checked={(this.state.forSale) ? this.state.forSale : false } name="forSale" value={'true'} onChange={this.handleCheckChange} /></label>
                            <label>no<input type="checkbox" checked={(!this.state.forSale) ? this.state.forSale : false } name="forSale" value={'false'} onChange={this.handleCheckChange} /></label>
                        </div>
