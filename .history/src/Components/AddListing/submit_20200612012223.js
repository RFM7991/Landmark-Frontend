    ...
    render() {
        return (
            <div style={{ display: 'flex', alignItems: 'flex-start',  flexDirection: 'column', padding: '20px' }}>
                <div style={{ borderBottom: '1px solid black', width: '80%', textAlign: 'left'}}>       
                    <h3>Review and Submit</h3>
                </div> 
                <br></br>
                
                <div style={{ borderBottom: '1px solid black', width: '30%', textAlign: 'left' }}>       
                ...
                <h3 style={{ fontSize: '24px', marginTop: '2em' }}>3. Pricing and Terms</h3>
