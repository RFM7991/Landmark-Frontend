        ...
        return (
            <div style={{ width: '100%', height: '100%', backgroundColor: 'whitesmoke', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', backgroundColor: 'green', flexDirection: 'row',  width: '80%' }}>
                    ...
                    <Button className="tabItem" onPress={() => this.handleTabPress(0)}>
                      Contact Info
                    </Button>
                    <Button className="tabItem" onPress={() => this.handleTabPress(1)}>
                      Location Details
                    </Button>
                    <Button className="tabItem" onPress={() => this.handleTabPress(2)}>
                        Pricing and terms
                    </Button>
                    <Button className="tabItem" onPress={() => this.handleTabPress(3)}>
                        Submit
                    </Button>
                </div>
