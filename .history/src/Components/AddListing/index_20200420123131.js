        ...
        return (
            ...
            display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column',  width: '80%', height: '100%', backgroundColor: 'rgba(255,255,255, 0.7)'}}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'flex-start', backgroundColor: 'red', flexDirection: 'column', padding: '20px' }}>
                        <div style={{ display: 'flex', alignItems: 'flex-start', backgroundColor: 'red', flexDirection: 'column', marginLeft: '20px' }}>
