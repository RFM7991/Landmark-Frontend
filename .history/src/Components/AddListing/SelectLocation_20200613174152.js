    ...
    render() {
        return (
            <div style={{ display: 'flex',  height: '80vh', alignItems: 'center', justifyContent: 'center',  flexDirection: 'column', padding: '20px' }}>
                ...
                <div style={{ flex: 1, flexDirection: 'row', alignItems: 'center', width: '100%'}}>
                    <div style={{ flex: 5, backgroundColor: 'red'}}> <AutoCompleteBar addressFunction={this.selectAddress}/></div>
