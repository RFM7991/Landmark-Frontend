...
class AddListing extends React.Component {
    ...
    handleCheckChange = async event => {
        ...
        await this.setState({[event.target.name]: event.target.value === 'true' })
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column', marginLeft: '24px', marginTop: '10px' }}>
                    <form>
                        ...
                        <div className="inputGroup">
                            <label>yes<input type="checkbox" checked={(this.state.forSale == undefined) ? this.state.forSale : false } name="forSale" value={'true'} onChange={this.handleCheckChange} /></label>
                            <label>no<input type="checkbox" checked={(this.state.forSale == undefined) ? this.state.forSale : false } name="forSale" value={'false'} onChange={this.handleCheckChange} /></label>
                        </div>

                        <strong>Is the property for lease?</strong>
                        <div className="inputGroup">
                            <label>yes<input type="checkbox" checked={(this.state.forLease == undefined) ? this.state.forLease : false } name="forLease" value={'true'} onChange={this.handleCheckChange} /></label>
                            <label>no<input type="checkbox" checked={(this.state.forLease == undefined) ? !this.state.forLease : false } name="forLease" value={'false'} onChange={this.handleCheckChange} /></label>
                        </div>
