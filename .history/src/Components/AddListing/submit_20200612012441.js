    ...
    render() {
        return (
            <div style={{ display: 'flex', alignItems: 'flex-start',  flexDirection: 'column', padding: '20px' }}>
                <div style={{ borderBottom: '1px solid black', textAlign: 'left', paddingRight: '5em'}}>       
                    <h3>Review and Submit</h3>
                </div> 
                <br></br>
                
                <div style={{ borderBottom: '1px solid black', paddingRight: '5em', textAlign: 'left' }}>       
                ...
                <div style={{ borderBottom: '1px solid black', paddingRight: '5em', textAlign: 'left', marginTop: '3em' }}>       
                ...
                <div style={{ borderBottom: '1px solid black', width: '30%', textAlign: 'left', marginTop: '3em' }}>       
