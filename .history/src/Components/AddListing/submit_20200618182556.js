        ...
        return (
            <div style={{ display: 'flex', alignItems: 'flex-start',  flexDirection: 'column', padding: '20px' }}>
                ...
                <div style={{ borderBottom: '1px solid rgb(31,33,48)', width: '20%', textAlign: 'left', marginTop: '3em' }}>       
                    ...
                    <div style={{ display: 'flex',  height: '250px', width: '100%',  overflowX: 'auto', flexDirection: 'row', alignItems: 'center', }}>
                        {this.props.photos.contact_photos.map((file, i) => {
                            return (
                                <div style={{ minWidth: '225px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgb(242,242,242)'}}>
