                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column', marginLeft: '24px', marginTop: '10px' }}>
                    <form>
                        ...
                        <div className="inputGroup">
                            <label>yes<input type="checkbox" checked={this.state.forSale} name="forSale" value={true} onChange={this.handleChange} /></label>
                            <label>no<input type="checkbox" checked={!this.state.forSale} name="forSale" value={false} onChange={this.handleChange} /></label>
                        </div>
