        ...
        return (
            <div style={{ display: 'flex', alignItems: 'flex-start',  flexDirection: 'column', padding: '20px' }}>
                ...
                <div style={{ width: '100%', height: '100px', display: 'flex', flexDirection: 'column',  backgroundColor: 'blue', alignSelf: 'center'}}>
                    ...
                    {this.state.loading &&  <div style={{ flex: 1, backgroundColor: 'green', display: 'flex', alignItems: 'center', justifyContent: 'center'}}><PropogateLoader  color='#00D4FF' size={10} /> </div>}
                    {!this.state.loading && 
                    <div style={{ flex: 1}}>
