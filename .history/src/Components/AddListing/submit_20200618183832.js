        ...
        return (
            <div style={{ display: 'flex', alignItems: 'flex-start',  flexDirection: 'column', padding: '20px' }}>
                ...
                <div style={{ borderBottom: '1px solid rgb(31,33,48)', width: '20%', textAlign: 'left', marginTop: '3em' }}>       
                    ...
                    <h3 style={{ fontSize: '22px', marginBottom: '0.5em'}}>Contact Photos:</h3>
                    {this.props.photos.contact_photos.length > 0 &&
                        <div style={{ display: 'flex',  height: '300px', width: '100%',  overflowX: 'auto', flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgb(242,242,242)' }}>
                            {this.props.photos.contact_photos.map((file, i) => {
                                return (
                                    <div style={{ minWidth: '225px', maxWidth: '225px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', }}>
                ...
                <h3 style={{ fontSize: '22px', marginBottom: '0.5em'}}>Location Photos:</h3>
                {this.props.photos.site_photos.length > 0 &&
                    <div style={{ display: 'flex',  height: '250px', width: '100%',  overflowX: 'auto', flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgb(242,242,242)' }}>
