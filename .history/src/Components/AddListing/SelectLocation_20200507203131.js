...
class SelectLocation extends React.Component {
    ...
    render() {
        return (
            <div style={{ display: 'flex',  backgroundColor: 'blue', alignItems: 'center',  flexDirection: 'column', padding: '20px' }}>
                <h3>Select Location</h3>
                <div style={{ width: '50%', paddingVertical: 100, height: '100%', backgroundColor: 'red'}}>
