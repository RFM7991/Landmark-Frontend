    ...
    render() {
        return (
            ...
            display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '80%', height: '100%', backgroundColor: 'rgba(255,255,255, 0.7)'}}>

                    <div style={{ width: '100%', backgroundColor: 'green'}}>
                        <h3>Owner/Broker Contact Info</h3>
                    </div>
                </div>
            </div>
       )
