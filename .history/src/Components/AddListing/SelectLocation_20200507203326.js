...
class SelectLocation extends React.Component {
    ...
    render() {
        return (
            <div style={{ display: 'flex',  height: '100vh', backgroundColor: 'blue', alignItems: 'center',  flexDirection: 'column', padding: '20px' }}>
                <br></br>
                <h3>Select Location</h3>
                <div style={{ width: '50%', marginTop: '5%', marginBottom: '10%',  backgroundColor: 'red'}}>
