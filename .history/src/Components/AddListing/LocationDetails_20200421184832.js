                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column', marginLeft: '24px', marginTop: '10px' }}>
                    ...
                    <label>yes<input type="checkbox" checked={this.state.forSale =="yes" } name="forSale" value={'yes'} onChange={this.handleChange} /></label>
                        ...
                        <div className="inputGroup">
                            <label>End cap<input type="checkbox" checked={this.state.forSale == "end cap" } name="position" value={'end cap'} onChange={this.handleChange} /></label>
                            <label>In-line<input type="checkbox" checked={this.state.forSale == "in-line" } name="position" value={'in-line'} onChange={this.handleChange} /></label>
                            <label>Free standing<input type="checkbox" checked={this.state.forSale == "free standing" } name="position" value={'free standing'} onChange={this.handleChange} /></label>
                            <label>(city) corner<input type="checkbox" checked={this.state.forSale == "corner" } name="position" value={'corner'} onChange={this.handleChange} /></label>
                            <label>(city) mid block<input type="checkbox" checked={this.state.forSale == "mid block" } name="position" value={'mid block'} onChange={this.handleChange} /></label>
                            <label>other<input type="checkbox" checked={this.state.forSale == "other" } name="position" value={'other'} onChange={this.handleChange} /></label>
                        </div>
