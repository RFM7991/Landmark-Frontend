            ...
            <div style={{ display: 'flex', alignItems: 'flex-start',  flexDirection: 'column', padding: '20px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column', marginLeft: '24px', marginTop: '10px' }}>
                    <form>
                        ...
                        <Form.Row>
                            <Form.Group as={Col} controlId="formGridZip" className="inputGroup">
                            <Form.Label>Is the property for sale?</Form.Label>
                            <Form.Control as="chckbox" name="isCity" onChange={this.onTempFormChange} value={this.state.distance}>
