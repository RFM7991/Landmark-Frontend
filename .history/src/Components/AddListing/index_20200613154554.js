...
class AddListing extends React.Component {
    ...
    constructor(props) {
        ...
        this.contactInfoIncomplete = this.state.formData.contactInfo.forSale == undefined || this.state.formData.contactInfo.forLease == undefined || this.state.formData.contactInfo.relationship == undefined
    }
            ...
            <div style={{ width: '100%', height: '100%', backgroundColor: lightBg, display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
               <div style={{ backgroundColor: 'rgba(146, 176, 179, 0.7)', width: '80%', height: '10%', flexDirection: 'column'}}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'row',  width: '80%' }}>
                    ...
                    <Button className="tabItem" onClick={() => this.handleTabPress(2)} disabled={this.state.formData.contactInfo == undefined}>
                      Location Details
                    </Button>
                    <Button className="tabItem" onClick={() => this.handleTabPress(3)} disabled={this.state.formData.contactInfo == undefined}>
                        Pricing and terms
                    </Button>
                    <Button className="tabItem" onClick={() => this.handleTabPress(4)} disabled={this.state.formData.contactInfo == undefined}>
                        Submit
                    </Button>
                </div>
