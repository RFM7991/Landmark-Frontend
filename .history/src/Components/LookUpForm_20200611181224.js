            ...
            <div className="lookup-form-block">
                ...
                <div style={{ display: 'flex', flexDirection: 'row'}}>
                    ...
                    <div style={{ flex: 1, alignItems: 'flex-end', justifyContent: 'center'}}>
                        ...
                        <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: 'red'}}>
                            <div style={{ fontSize: '14px', marginRight: '0.5em'}}>How to use</div>
