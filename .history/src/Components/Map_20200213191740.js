...
class SimpleMap extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      loadingCart : {[ZIP] : false, [TRADE_ZONE] : false},
      mapOptions : {
  ...
  renderCartography() {
    // clear data layer 
      ...
      console.log('RENDER CART', this.props.data_range)
      // render cartography
...
generateHeading = () => {
 ...
 //  console.log('map props', this.props)
  ...
  <div className='map-control_bar'>
    ...
    <Button style={{ fontSize: 14, marginRight: '1em'}} onClick={this.props.runJoyRideTutorial}>Help</Button>
      <Button style={{ fontSize: 14, marginRight: '1em'}} variant="light" onClick={this.onHandleCenter}> 
        Center
      </Button>
    ...
    return (
      ...
      <div style={{height: this.props.height}}>
        ...
        <div style={{position: 'relative', width: '100%', height: '100%'}}>
          ...
          {this.state.loadingCart[this.props.data_range] && 
          <div style={{
