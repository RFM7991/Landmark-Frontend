        ...
        return (
            <div className="lookup-form-block">
                ...
                <div style={{ width: '100%',  display: 'flex'}}>
                    ...
                    <div style={{flex: 1, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: '0.5em' }}>
                        <div style={{ fontSize: '16px', marginRight: '0.75em', color: 'white'}}>How to use</div>
