    ...
    render() {
        ...
        return (
            ...
            <Form style={{ flexDirection : 'row', justifyContent: 'center'}}>
                {this.state.address != undefined && !this.state.error && <Button  variant="primary" onClick={this.onHandleSubmit} style={{backgroundColor:'#00d4ff', fontWeight: 'bold'}}>
                    Submit</Button>
                }
                {this.state.address == undefined || this.state.error && <Button  variant="primary" onClick={this.onHandleAddressWarning} style={{backgroundColor:'#00d4ff', fontWeight: 'bold', opacity: 0.75}}>
                    Submit</Button>
                }
            </Form>
