      ...
      <div className='map_container'>
        ...
        <button className='map-control_button'  onClick={this.loadMorePlaces} style={{margin: 'auto'}}>
          More
           ...
           <button className='map-control_button'  onClick={this.loadDefaultPlaces} style={{margin: 'auto'}}>
           Competitors
          </button> 
          <button className='map-control_button'  onClick={this.loadAllPlaces} style={{margin: 'auto'}}>
           All
          </button> 
         </div>
