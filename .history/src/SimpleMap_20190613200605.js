...
import { SELECTED, DEFAULT, HOME, COMPETITION } from './Marker' 
      ...
      <div style={{height: '75vh'}}>
        ...
        >
          ...
          {Array.from(this.props.places).map((place, i) => {
            ...
            } else if (place.types.includes(this.state.business_type)) {
              type = COMPETITION
              show = false
          }
          console.log(this.state.business_type, place.types.includes(this.state.business_type))
