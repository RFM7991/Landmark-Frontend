...
class LookUpForm extends React.Component {
    ...
    constructor(props) {
        ...
        this.onUpdateBusiness = this.onUpdateBusiness.bind(this);
    ...
    onUpdateBusiness(business_type) {
        this.props.onUpdateBusiness(business_type)
    }
        ...
        return (
            ...
            <Form>
                ...
                <Form.Group as={Col} controlId="formGridZip">
                        ...
                        <option>Convenvience Store</option>
                    </Form.Control>
                    </Form.Group>
                </Form.Row>
...
const business_typeSelector = createSelector (
...
const mapActionsToProps = {
     ...
     onUpdateBusiness: updateBusinessType
};
