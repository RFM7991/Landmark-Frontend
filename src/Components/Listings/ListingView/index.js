                    ...
                    <div style={(this.state.listingData == undefined) ? { width: '100%', height: '100vh', display: 'flex', alignItems:'center', justifyContent: 'center'} : {display : 'none'}}> 
                        ...
                        { this.state.listingData != undefined &&
                            <div style={{ display: 'flex', flexDirection: 'column',  width: '100%', height: '100%', backgroundColor: lightBg, }}>
                                <div id="listingHeader" style={{paddingTop: '1em', paddingBottom: '0.5em', paddingLeft: '1.5em', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%', backgroundColor: lightBg}}>
                                    ...
                                    <div style={{ display: 'flex', flex: 1  }}>
                                        <h2 style={{ color: 'white', textDecorationLine: 'underline',}}>{this.state.listingData.location.formatted}</h2>
                                    </div>
                                    <div style={{ display: 'flex', flex: 1, justifyContent: 'flex-end', paddingRight: '1.5em'}}>
                                        <PublishedStatus published={this.state.listingData.published} size="3x" fontColor="white"/>
                                    </div>
                                </div>
